...
#ifdef GFS
character(len=max_varname_length), dimension(6) :: svars3d_supported = (/ 'u', 'v', 'tv', 'q', 'oz', 'cw'/)
character(len=max_varname_length), dimension(2) :: svars2d_supported = (/ 'ps', 'pst' /)
#endif
#ifdef WRF
character(len=max_varname_length), dimension(7) :: svars3d_supported = (/'u', 'v', 'tv', 'q', 'cw', 'w', 'ph' /)
character(len=max_varname_length), dimension(2) :: svars2d_supported = (/ 'pd', 'mu' /)
#endif
#ifdef NMMB
character(len=max_varname_length), dimension(6) :: svars3d_supported = (/ 'u', 'v', 'tv', 'q', 'oz', 'cw'/)
character(len=max_varname_length), dimension(1) :: svars2d_supported = (/ 'ps' /)
#endif
