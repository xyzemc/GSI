...
character(len=max_varname_length),public, dimension(6) :: vars3d_supported = (/ 'u', 'v', 'tv', 'q', 'oz', 'cw'/)
character(len=max_varname_length),public, dimension(1) :: vars2d_supported = (/ 'ps' /)
contains
