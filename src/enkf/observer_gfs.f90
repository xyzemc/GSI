...
private
public init_observer_enkf, calc_linhx, destroy_observer_enkf
...
subroutine calc_linhx(hx, dens, rlat, rlon, time, dhx_dx, hx_ens, vscale)
...
! Declare passed variables
  ...
  real(r_double),dimension(nlevs+1)                ,intent(in   ) :: vscale       ! vertical scaling (for modulated ens)
