module gridinfo
  ...
  character(len=max_varname_length),public, dimension(7) :: vars3d_supported = (/'u', 'v', 'tv', 'q', 'cw', 'w', 'ph' /)
  character(len=max_varname_length),public, dimension(2) :: vars2d_supported = (/ 'pd', 'mu' /)
