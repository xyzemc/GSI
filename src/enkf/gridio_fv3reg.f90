...
!cltthinkdeb      filename = trim(adjustl(datapath))//trim(adjustl(fileprefixes(nb)))//"fv3_tile"//char_tile//trim(charnanal)//"_dynvartracer"
      filename = "fv3_tile"//char_tile(1:1)//"_ens_"//trim(charnanal)//"_dynvartracer"
