...
!              do k=1,33
!                 if( etabl_t(l-99,k,m) < 1.e8_r_single)
!                 etabl_t(l-99,k,m)=etabl_t(l-99,k,m)*so(1,i)
!              end do
!              if(l==120 ) then
...
!              do k=1,33
!                if( etabl_q(l-99,k,m) < 1.e8_r_single)
!                 etabl_q(l-99,k,m)=etabl_t(l-99,k,m)*so(1,i)
!              end do
!              if(l==120 ) then
!                 write(235,*)l,trim(ioctype(i)),'33'
!              else
...
!             do k=1,33
!                 if( etabl_uv(l-199,k,m) < 1.e8_r_single)
!                 etabl_uv(l-199,k,m)=etabl_uv(l-199,k,m)*so(1,i)
!              end do
!
...
!              do k=1,33
!                 if( etabl_ps(l-99,k,m) < 1.e8_r_single)
!                 etabl_ps(l-99,k,m)=etabl_ps(l-99,k,m)*so(1,i)
!             end do
!              write(235,*)l,trim(ioctype(i)),'1'
!           else
!              cycle
