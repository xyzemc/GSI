...
! Declare passed variables
  real(r_kind),save,dimension(33,300,4) ::  penalty,trace

! Declare local variables
  real(r_kind) err2

  integer(i_kind) i,n,k,ibin,ier,istatus
  real(r_kind) tpenalty(33,300,4),ttrace(33,300,4)
  real(r_kind) valu,valv,val,so(33,300,4),sosum
  integer(i_kind) itype,ncat,k1,m,l
  real(r_kind) cat_num(33,300,4),tcat_num(33,300,4),cat_numt(300,4)
  real(r_kind),pointer,dimension(:):: xhat_u,xhat_v,xhat_q,xhat_t,xhat_p
  character(2) obtype(4)
