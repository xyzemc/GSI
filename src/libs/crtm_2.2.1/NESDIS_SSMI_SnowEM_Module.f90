...
MODULE NESDIS_SSMI_SnowEM_Module
  ...
  '$Id: NESDIS_SSMI_SnowEM_Module.f90 55163 2015-04-21 13:59:28Z paul.vandelst@noaa.gov $'
...
!
! PURPOSE:
!       Subroutine to simulate microwave emissivity over snow conditions from AMSU measurements at
!       window channels.
!
! REFERENCES:
...
! CALLS:
!
!       SSMI_SnowEM_CORE : Subroutine to calculate the microwave emissivity over snow conditions
!
!
!
! PROGRAM HISTORY LOG:
...
!                .      .    .                                       .
! subprogram: SSMI_SnowEM_CORE  noaa/nesdis SSM/I emissivity model over snow
!
