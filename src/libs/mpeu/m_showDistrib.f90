...
!EOP ___________________________________________________________________
  ...
  if(myID==root) then
    ...
    imbx=nint(100.*(imx-iav)/max(real(sum),1.))
    imbr=nint(100.*(iov    )/max(real(sum),1.))
...
!EOP ___________________________________________________________________
  ...
  if(myID==root) then
    ...
    imbx=nint(100.*(rmx-avg)/max(real(sum),1.))
    imbr=nint(100.*(rov    )/max(real(sum),1.))
    imbi=nint(100.*(rmx-avg)/max(real(rmx),1.))
