...
!BOP -------------------------------------------------------------------
!
! !IROUTINE: ciI4_ - check in as an integer rank 4 array
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!EOP ___________________________________________________________________
  ...
  character(len=*),parameter :: myname_=myname//'::ciI4_'

  if(mall_on) call ci_(size(marg),thread)

end subroutine ciI4_
...
!BOP -------------------------------------------------------------------
!
! !IROUTINE: ciR4_ - check in as a real(SP) rank 4 array
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!EOP ___________________________________________________________________
  ...
  character(len=*),parameter :: myname_=myname//'::ciR4_'

  if(mall_on) call ci_(size(marg),thread)

end subroutine ciR4_
...
!BOP -------------------------------------------------------------------
!
! !IROUTINE: ciD4_ - check in as a real(DP) rank 4 array
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!EOP ___________________________________________________________________
  ...
  character(len=*),parameter :: myname_=myname//'::ciD4_'

  if(mall_on) call ci_(2*size(marg),thread)

end subroutine ciD4_
...
!BOP -------------------------------------------------------------------
!
! !IROUTINE: ciL4_ - check in as a logical rank 4 array
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!EOP ___________________________________________________________________
  ...
  character(len=*),parameter :: myname_=myname//'::ciL4_'

  if(mall_on) call ci_(size(marg),thread)

end subroutine ciL4_
...
!BOP -------------------------------------------------------------------
!
! !IROUTINE: ciC4_ - check in as a character rank 4 array
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!EOP ___________________________________________________________________
  ...
  character(len=*),parameter :: myname_=myname//'::ciC4_'
  integer :: nw

  if(.not.mall_on) return
  nw=(len(marg(1,1,1,1))+NBYTE_PER_WORD-1)/NBYTE_PER_WORD
  call ci_(size(marg)*nw,thread)

end subroutine ciC4_
...
!BOP -------------------------------------------------------------------
!
! !IROUTINE: coI4_ - check in as an integer rank 4 array
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!EOP ___________________________________________________________________
  ...
  character(len=*),parameter :: myname_=myname//'::coI4_'

  if(mall_on) call co_(size(marg),thread)

end subroutine coI4_
...
!BOP -------------------------------------------------------------------
!
! !IROUTINE: coR4_ - check in as a real(SP) rank 4 array
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!EOP ___________________________________________________________________
  ...
  character(len=*),parameter :: myname_=myname//'::coR4_'

  if(mall_on) call co_(size(marg),thread)

end subroutine coR4_
...
!BOP -------------------------------------------------------------------
!
! !IROUTINE: coD4_ - check in as a real(DP) rank 4 array
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!EOP ___________________________________________________________________
  ...
  character(len=*),parameter :: myname_=myname//'::coD4_'

  if(mall_on) call co_(2*size(marg),thread)

end subroutine coD4_
...
!BOP -------------------------------------------------------------------
!
! !IROUTINE: coL4_ - check in as a logical rank 4 array
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!EOP ___________________________________________________________________
  ...
  character(len=*),parameter :: myname_=myname//'::coL4_'

  if(mall_on) call co_(size(marg),thread)

end subroutine coL4_
...
!BOP -------------------------------------------------------------------
!
! !IROUTINE: coC4_ - check in as a character rank 4 array
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!EOP ___________________________________________________________________
  ...
  character(len=*),parameter :: myname_=myname//'::coC4_'
  integer :: nw
