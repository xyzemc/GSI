...
C  -----
      ...
      RETURN
C900   WRITE(BORT_STR,'("BUFRLIB: MSGINI - MISMATCH BETWEEN INODE (=",'//
C     . 'I7,") & POSITIONAL INDEX, INOD (",I7,") OF SUBTAG (",A,") IN '//
C     . 'DICTIONARY")') INODE(LUN),INOD,SUBTAG
C      CALL BORT(BORT_STR)
