...
C  -----
      ...
      RETURN
9000  format('BUFRLIB: MSGINI - MISMATCH BETWEEN INODE (=',I7,
     &       '& POSITIONAL INDEX, INOD (',I7,') OF SUBTAG (',A,
     &       ') INDICTIONARY')
900   WRITE(BORT_STR,9000)INODE(LUN),INOD,SUBTAG
      CALL BORT(BORT_STR)

9001  format('BUFRLIB: MSGINI - TABLE A MESSAGE TYPE MNEMONIC ',A,
     &       ' NOT FOUND IN INTERNAL TABLE D ARRAYS')
901   WRITE(BORT_STR,9001)SUBTAG
      CALL BORT(BORT_STR)
902   CALL BORT(
