...
! Declare local variables
  ...
  integer(i_kind):: isflg,idomsfc(1)
...
!                 (3) - snow percentage
           ...
           if( idomsfc(1) /= zero)  cycle read_loop                         ! use data over water only
...
!
           ...
           data_all(14,ndata) = idomsfc(1)+0.001_r_kind ! dominate surface type
