...
! !INTERFACE:
    ...
    module m_zeit
      use m_sysclocks, only: zeit_kind => sysclocks_kind
      implicit none
      private	! except
...
write(lu,'(80a)') ('-',i=1,80)
write(lu,'(a)') 'where'
write(lu,'(a)') '        x% := 100* [max(t) - avg(t)]/sum(t)'
write(lu,'(a)') '        r% := 100* sum[t-avg(t); t>avg(t)]/sum(t)'
write(lu,'(a)') '        i% := 100* [max(t) - avg(t)]/max(t)'
write(lu,'(80a)') ('-',i=1,80)
