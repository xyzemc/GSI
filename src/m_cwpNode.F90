...
!                .      .    .                                       .
! subprogram:	 module m_cwpNode
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2016-05-18
!
! abstract: class-module of obs-type cwpNode (cloud water path)
!
! program history log:
...
! module interface:
  ...
  type,extends(obsNode):: cwpNode
     !type(cwp_ob_type),pointer :: llpoint => NULL()
     ...
     real(r_kind)    :: cbp        !  cloud base pressure
     real(r_kind)    :: ctp        !  cloud top pressure
  ...
  public:: cwpNode_typecast
  public:: cwpNode_nextcast
        interface cwpNode_typecast; module procedure typecast_ ; end interface
        interface cwpNode_nextcast; module procedure nextcast_ ; end interface

  character(len=*),parameter:: MYNAME="m_cwpNode"
...
!-- cast a class(obsNode) to a type(cwpNode)
  use m_obsNode, only: obsNode
  implicit none
  type(cwpNode),pointer:: ptr_
...
!-- cast an obsNode_next(obsNode) to a type(cwpNode)
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(cwpNode),intent(inout):: aNode
