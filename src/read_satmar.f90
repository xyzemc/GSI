...
! => Abstract                       :     
!      1. This routine reads data from three different altimeters (Jason-2,
...
!   call init_constants_derived
   ...
   namesat(1:nosat) = (/'NC031115','NC031122','NC031123','NC031124'/)
   tot = 0 
   cnt = 0
   irec = 0 
   cnt1 = 0
...
!
         ...
         data_all(4,iout) = zero                !105.0       ! pressure (in cb)
