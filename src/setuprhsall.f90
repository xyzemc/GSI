...
! Delcare local variables
  ...
  integer(i_kind) lunin,nobs,nchanl,nreal,nele,&
       ...
       i_mxtm,i_mitm,i_pmsl,i_howv,i_tcamt,i_lcbas,i_cldch,i_uwnd10m,i_vwnd10m,i_dbz,iobs,nprt,ii,jj
...
!    Compute and print statistics for "conventional" data
     call statsconv(mype,&
          ...
          i_tcamt,i_lcbas,i_cldch,i_uwnd10m,i_vwnd10m,i_dbz,i_ref,bwork1,awork1,ndata)
