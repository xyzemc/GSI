...
!       corresponding to these variables in the BUFR file. Developments for the 
!       calculation of observation errors and quality control (sanity checks) are 
!       expected in future upgrades to the "GOES-16/GLM variational lightning 
...
!           Set usage variable              
            ...
            if (lob) then
               ...
               cdata_all(6,iout) =idate                ! analysis time
