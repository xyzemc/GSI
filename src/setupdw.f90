...
use abstract_setup_mod
  ...
  character(len=10) :: myname="setupdw"
  contains
    procedure, pass(this) :: setup => setupdw
    procedure, pass(this) :: init_vars_ => init_vars_dw
...
!   real(r_kind),allocatable,dimension(:,:,:,:) :: ges_v
  ...
  ! and log(pres) at mid-layers to observation location.
       ...
       call tintrp2a11(this%ges_z,zsges,dlat,dlon,dtime,hrdifsig,&      ! jsw
            mype,nfldsig)                                    ! jsw
  ...
  ! First, interpolate u,v guess to observation location
       call tintrp31(this%ges_u,ugesindw,dlat,dlon,dpres,dtime,&
          hrdifsig,mype,nfldsig)
       call tintrp31(this%ges_v,vgesindw,dlat,dlon,dpres,dtime,&
          hrdifsig,mype,nfldsig) 
