...
!                             variational/direct lightning data assimilation.
!                .      .    .                                       .
...
! South quadrant
     ...
     real(r_kind),dimension(:),pointer  :: jac_qi5 => NULL()
     real(r_kind),dimension(:),pointer  :: jac_qi7 => NULL()
     real(r_kind),dimension(:),pointer  :: jac_ti5 => NULL()
     real(r_kind),dimension(:),pointer  :: jac_ti7 => NULL()
...
! North quadrant
     ...
     real(r_kind),dimension(:),pointer  :: jac_qi6 => NULL()
     real(r_kind),dimension(:),pointer  :: jac_qi8 => NULL()
     real(r_kind),dimension(:),pointer  :: jac_ti6 => NULL()
     real(r_kind),dimension(:),pointer  :: jac_ti8 => NULL()
...
! West quadrant
     ...
     real(r_kind),dimension(:),pointer  :: jac_qi9  => NULL()
     real(r_kind),dimension(:),pointer  :: jac_qi10 => NULL()
     real(r_kind),dimension(:),pointer  :: jac_ti9  => NULL()
     real(r_kind),dimension(:),pointer  :: jac_ti10 => NULL()
...
! East quadrant
     ...
     real(r_kind),dimension(:),pointer  :: jac_qi11 => NULL()
     real(r_kind),dimension(:),pointer  :: jac_qi12 => NULL()
     real(r_kind),dimension(:),pointer  :: jac_ti11 => NULL()
     real(r_kind),dimension(:),pointer  :: jac_ti12 => NULL()
...
_ENTRY_(myname_)
  ...
  allocate(aNode%jac_qi1(nsig),     aNode%jac_qi2(nsig),      &
           ...
           aNode%jac_qi5(nsig),     aNode%jac_qi6(nsig),      &
           aNode%jac_qi7(nsig),     aNode%jac_qi8(nsig),      &
           aNode%jac_qi9(nsig),     aNode%jac_qi10(nsig),     &
           aNode%jac_qi11(nsig),    aNode%jac_qi12(nsig)      )

  allocate(aNode%jac_ti1(nsig),     aNode%jac_ti2(nsig),      &
           aNode%jac_ti3(nsig),     aNode%jac_ti4(nsig),      &
           aNode%jac_ti5(nsig),     aNode%jac_ti6(nsig),      &
           aNode%jac_ti7(nsig),     aNode%jac_ti8(nsig),      &
           aNode%jac_ti9(nsig),     aNode%jac_ti10(nsig),     &
           aNode%jac_ti11(nsig),    aNode%jac_ti12(nsig)      )
...
!_TRACEV_(myname_,'%mytype() =',aNode%mytype())
     ...
     if(associated(aNode%jac_qi5 )) deallocate(aNode%jac_qi5 )
     if(associated(aNode%jac_qi6 )) deallocate(aNode%jac_qi6 )
     if(associated(aNode%jac_qi7 )) deallocate(aNode%jac_qi7 )
     if(associated(aNode%jac_qi8 )) deallocate(aNode%jac_qi8 )
     if(associated(aNode%jac_qi9 )) deallocate(aNode%jac_qi9 )
     if(associated(aNode%jac_qi10)) deallocate(aNode%jac_qi10)
     if(associated(aNode%jac_qi11)) deallocate(aNode%jac_qi11)
     if(associated(aNode%jac_qi12)) deallocate(aNode%jac_qi12)
     ...
     if(associated(aNode%jac_ti5 )) deallocate(aNode%jac_ti5 )
     if(associated(aNode%jac_ti6 )) deallocate(aNode%jac_ti6 )
     if(associated(aNode%jac_ti7 )) deallocate(aNode%jac_ti7 )
     if(associated(aNode%jac_ti8 )) deallocate(aNode%jac_ti8 )
     if(associated(aNode%jac_ti9 )) deallocate(aNode%jac_ti9 )
     if(associated(aNode%jac_ti10)) deallocate(aNode%jac_ti10)
     if(associated(aNode%jac_ti11)) deallocate(aNode%jac_ti11)
     if(associated(aNode%jac_ti12)) deallocate(aNode%jac_ti12)
