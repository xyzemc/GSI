...
! For qc
  ...
  real(r_kind) isflg_1,isflg_2,isflg_3,isflg_4
...
!                 (3) - snow percentage
        ...
        call deter_sfc(dlat,dlon,dlat_earth+0.7,dlon_earth+0.7,tdiff,isflg_1, &
           idomsfc,sfcpct_1,ts,sstx_1,vty,vfr,sty,stp,sm,sn,zz,ff10,sfcr,mype)
        call deter_sfc(dlat,dlon,dlat_earth+0.7,dlon_earth-0.7,tdiff,isflg_2, &
           idomsfc,sfcpct_2,ts,sstx_2,vty,vfr,sty,stp,sm,sn,zz,ff10,sfcr,mype)
        call deter_sfc(dlat,dlon,dlat_earth-0.7,dlon_earth+0.7,tdiff,isflg_3, &
           idomsfc,sfcpct_3,ts,sstx_3,vty,vfr,sty,stp,sm,sn,zz,ff10,sfcr,mype)
        call deter_sfc(dlat,dlon,dlat_earth-0.7,dlon_earth-0.7,tdiff,isflg_4, &
           idomsfc,sfcpct_4,ts,sstx_4,vty,vfr,sty,stp,sm,sn,zz,ff10,sfcr,mype)
...
!       Compute "score" for observation.  All scores>=0.0.  Lowest score is "best"
        ...
        data_all( 6,iout)= zero                 !local azimuth angle (missing)
        ...
        data_all(10,iout)= zero                 !solar azimuth angle (deg) : not used for MW-RT calc
