...
! Declare passed variables
  integer(i_kind)                                  ,intent(in   ) :: mype,i_ps,i_uv,&
       ...
       i_cldch,i_uwnd10m,i_vwnd10m,i_swcp,i_lwcp,i_ref,i_dbz,i_cwp,i_td
...
! Declare local variables
  ...
  real(r_kind) dbzmplty,tdbz, qctdbz,dbzqcplty
