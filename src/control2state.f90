...
real(r_kind),pointer,dimension(:,:)   :: sv_gust=>NULL(),sv_vis=>NULL()
real(r_kind),pointer,dimension(:,:)   :: sv_pblh=>NULL(),sv_wspd10m=>NULL()
real(r_kind),pointer,dimension(:,:)   :: sv_tcamt=>NULL(),sv_lcbas=>NULL()
real(r_kind),pointer,dimension(:,:)   :: sv_td2m=>NULL(),sv_mxtm=>NULL()
real(r_kind),pointer,dimension(:,:)   :: sv_mitm=>NULL(),sv_pmsl=>NULL()
real(r_kind),pointer,dimension(:,:)   :: sv_howv=>NULL(),sv_cldch=>NULL()
real(r_kind),pointer,dimension(:,:)   :: sv_uwnd10m=>NULL(),sv_vwnd10m=>NULL()
real(r_kind),pointer,dimension(:,:,:) :: sv_u=>NULL(),sv_v=>NULL(),sv_w=>NULL()
real(r_kind),pointer,dimension(:,:,:) :: sv_prse=>NULL(),sv_q=>NULL()
real(r_kind),pointer,dimension(:,:,:) :: sv_tsen=>NULL(),sv_tv=>NULL()
