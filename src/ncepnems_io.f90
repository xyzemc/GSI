...
!
! remarks:
!    1. iyear and month could come from obsmod, but logically
...
!   2018-10-31  Wei/Martin - modified to read NEMS aerosols
!
!   input argument list:
!
!   output argument list:
...
!   2018-10-31  Wei/Martin  added optional gfschem_bundle argument to write aer
!
!   input argument list:
...
! du001
    ...
    do k=1,grd%nsig
       ...
       if (mype == mype_out) then
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "du001 lv",k," max= ",lmax," min= ",lmin
    ...
    if (mype==0) write(6,*) "after write out du001"
! du002
    do k=1,grd%nsig
       lmax=0.
       lmin=0.
       ...
       if (mype == mype_out) then
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "du002 lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
    ...
    if (mype==0) write(6,*) "after write out du002"
! du003
    do k=1,grd%nsig
       lmax=0.
       lmin=0.
       ...
       if (mype == mype_out) then
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "du003 lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
    ...
    if (mype==0) write(6,*) "after write out du003"
! du004
    do k=1,grd%nsig
       lmax=0.
       lmin=0.
       ...
       if (mype == mype_out) then
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "du004 lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
    ...
    if (mype==0) write(6,*) "after write out du004"
! du005
    do k=1,grd%nsig
       lmax=0.
       lmin=0.
       ...
       if (mype == mype_out) then
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "du005 lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
    ...
    if (mype==0) write(6,*) "after write out du005"
...
!
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "ss001 lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)

          rwork1d1=rwork1d1*1.0e-9_r_kind ! convert ug/kg back to kg/kg
          lmax=maxval(rwork1d1)
          lmin=minval(rwork1d1)
          write(301,*) "ss002 lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d1(12345)
    ...
    if (mype==0) write(6,*) "after write out ss001 and ss002"
! ss003
    do k=1,grd%nsig
       lmax=0.
       lmin=0.
       ...
       if (mype == mype_out) then
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "ss003 lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
    ...
    if (mype==0) write(6,*) "after write out ss003"
! ss004
    do k=1,grd%nsig
       lmax=0.
       lmin=0.
       ...
       if (mype == mype_out) then
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "ss004 lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
    ...
    if (mype==0) write(6,*) "after write out ss004"
! ss005
    do k=1,grd%nsig
       lmax=0.
       lmin=0.
       ...
       if (mype == mype_out) then
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "ss005 lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
    ...
    if (mype==0) write(6,*) "after write out ss005"
! dms, msa, so2
       do k=1,grd%nsig
       if (mype == mype_out) then
       ...
       lmin=0.
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "dms lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
       ...
       if (mype==0) write(6,*) "after write out dms"
       ...
       lmin=0.
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "msa lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
       ...
       if (mype==0) write(6,*) "after write out msa"
       ...
       lmin=0.
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "so2 lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
       ...
       if (mype==0) write(6,*) "after write out so2"
! so4
    do k=1,grd%nsig
       lmax=0.
       lmin=0.
       ...
       if (mype == mype_out) then
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "so4 lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
    ...
    if (mype==0) write(6,*) "after write out so4"
! oc1
    do k=1,grd%nsig
       ...
       if (mype == mype_out) then
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "ocphobic lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
    ...
    if (mype==0) write(6,*) "after write out ocphobic"
! oc2
    do k=1,grd%nsig
       lmax=0.
       lmin=0.
       ...
       if (mype == mype_out) then
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "ocphilic lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
    ...
    if (mype==0) write(6,*) "after write out ocphilic"
! bc1
    do k=1,grd%nsig
       lmax=0.
       lmin=0.
       ...
       if (mype == mype_out) then
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "bcphobic lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
    ...
    if (mype==0) write(6,*) "after write out bcphobic"
! bc2
    do k=1,grd%nsig
       lmax=0.
       lmin=0.
       ...
       if (mype == mype_out) then
          ...
          lmax=maxval(rwork1d)
          lmin=minval(rwork1d)
          write(301,*) "bcphilic lv",k," max= ",lmax," min= ",lmin
          write(301,*) rwork1d(12345)
