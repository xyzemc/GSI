...
!     parallel_ncio - option to use parallel netCDF when use_gfs_ncio is true and GSI is compiled with parallel enabled netCDF
...
!            add use of guess file later for regional mode.
  ...
  namelist/setup/gencode,factqmin,factqmax,clip_supersaturation, &
       ...
       lwrite_peakwt,use_gfs_nemsio,use_gfs_ncio,parallel_ncio,sfcnst_comb,liauon,use_prepb_satwnd,l4densvar,ens_nstarthr,&
