...
! !USES:
  ...
  use correlated_obsmod, only: GMAO_ObsErrorCov
...
!  12-16-2019 W. Gu     - add GMAO_ObsErrorCov from MODULE CORRELATED_OBSMOD to NAMELIST/SETUP to support
