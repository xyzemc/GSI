...
!           .      .    .                                       .
! module:   stpwspd10mmod    module for stpwspd10m_search and stpwspd10m
!  prgmmr:
!
! abstract: module for stpwspd10m_search and stpwspd10m
!
! program history log:
!   2014-03-19  pondeca
!   2016-05-18  guo     - replaced ob_type with polymorphic obsNode through type casting
!   2019-08-15  kbathmann - split into stpwspd10m and stpwspd10m_search
!
! subroutines included:
!   sub stpwspd10m_search,stpwspd10m
!
! attributes:
!   language: f90
!   machine:
...
PRIVATE
PUBLIC stpwspd10m_search,stpwspd10m

contains

subroutine stpwspd10m_search(wspd10mhead,rval,out,sges,nstep)
!$$$  subprogram documentation block
!                .      .    .                                       .
! subprogram: stpwspd10m_search  calculate search direction, penalty and contribution to stepsize
!
! abstract: calculate search direction, penalty and contribution to stepsize for 10m-wind speed
  ...
  do while (associated(wspd10mptr))
     if(wspd10mptr%luse)then
        if(nstep > 0)then
           ...
           wspd10mptr%val =w1*rwspd10m(j1)+w2*rwspd10m(j2)+w3*rwspd10m(j3)+w4*rwspd10m(j4)

           do kk=1,nstep
              wspd10m=wspd10mptr%val2+sges(kk)*wspd10mptr%val
...
!  Modify penalty term if nonlinear QC
  ...
  end do !while associated(wspd10mptr)
  
  return
end subroutine stpwspd10m_search

subroutine stpwspd10m(wspd10mhead,out,sges,nstep)
!$$$  subprogram documentation block
!                .      .    .                                       .
...
!
!   output argument list:
!     out(1:nstep)   - contribution to penalty for conventional wspd10m -
!     sges(1:nstep)
!
! attributes:
!   language: f90
