...
!                .      .    .                                       .
! subprogram:	 module m_gustNode
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2016-05-18
!
! abstract: class-module of obs-type gustNode (surface gust)
!
! program history log:
...
! module interface:
  ...
  public:: gustNode_typecast
  public:: gustNode_nextcast
        interface gustNode_typecast; module procedure typecast_ ; end interface
        interface gustNode_nextcast; module procedure nextcast_ ; end interface
...
!-- cast a class(obsNode) to a type(gustNode)
  use m_obsNode, only: obsNode
  implicit none
  type(gustNode),pointer:: ptr_
...
!-- cast an obsNode_next(obsNode) to a type(gustNode)
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(gustNode), intent(inout):: aNode
...
subroutine obsNode_xwrite_(aNode,junit,jstat)
  implicit none
  class(gustNode),intent(in):: aNode
