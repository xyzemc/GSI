...
!                .      .    .                                       .
! subprogram:	 module m_tcpNode
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2016-05-18
!
! abstract: class-module of obs-type tcpNode (TC MSLP data)
!
! program history log:
...
! module interface:
  ...
  public:: tcpNode_typecast
  public:: tcpNode_nextcast
        interface tcpNode_typecast; module procedure typecast_ ; end interface
        interface tcpNode_nextcast; module procedure nextcast_ ; end interface
...
!-- cast a class(obsNode) to a type(tcpNode)
  use m_obsNode, only: obsNode
  implicit none
  type(tcpNode),pointer:: ptr_
...
!-- cast an obsNode_next(obsNode) to a type(tcpNode)
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(tcpNode), intent(inout):: aNode
