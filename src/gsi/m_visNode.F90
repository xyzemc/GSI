...
!                .      .    .                                       .
! subprogram:	 module m_visNode
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2016-05-18
!
! abstract: class-module of obs-type visNode (surface vis(ibility))
!
! program history log:
...
! module interface:
  ...
  public:: visNode_typecast
  public:: visNode_nextcast
        interface visNode_typecast; module procedure typecast_ ; end interface
        interface visNode_nextcast; module procedure nextcast_ ; end interface
...
!-- cast a class(obsNode) to a type(visNode)
  use m_obsNode, only: obsNode
  implicit none
  type(visNode),pointer:: ptr_
...
!-- cast an obsNode_next(obsNode) to a type(visNode)
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(visNode), intent(inout):: aNode
