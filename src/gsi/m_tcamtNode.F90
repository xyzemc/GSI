...
!                .      .    .                                       .
! subprogram:	 module m_tcamtNode
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2016-05-18
!
! abstract: class-module of obs-type tcamtNode (tcamt)
!
! program history log:
...
! module interface:
  ...
  type,extends(obsNode):: tcamtNode
     ! private
  ...
  public:: tcamtNode_typecast
  public:: tcamtNode_nextcast
        interface tcamtNode_typecast; module procedure typecast_ ; end interface
        interface tcamtNode_nextcast; module procedure nextcast_ ; end interface
 
  character(len=*),parameter:: MYNAME="m_tcamtNode"
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(tcamtNode), intent(inout):: aNode
...
subroutine obsNode_xwrite_(aNode,junit,jstat)
  implicit none
  class(tcamtNode),intent(in):: aNode
