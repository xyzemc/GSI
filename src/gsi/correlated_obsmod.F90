...
! This does the actual full Cholesky factorization of the matrix
   ...
   call decompose_(ErrorCov%UTfull,ndim)
endif
...
!BOC
  ...
  integer(i_kind) :: nch_active,ii,jj,kk,iii,jjj,mm,ncp,ifound,nsigjac,indR
