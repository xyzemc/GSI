module mxtm_setup
  ...
  private
  public:: setup
        interface setup; module procedure setupmxtm; end interface

contains
subroutine setupmxtm(obsLL,odiagLL,lunin,mype,bwork,awork,nele,nobs,is,conv_diagsave)
...
!                                     time in analysis
!   2020-01-23  guo     - removed mxtmhead alias.
...
!    in inner loop minimization (int* and stp* routines)
     if (.not. last .and. muse(i)) then
        ...
        allocate(my_head)
        call mxtmNode_appendto(my_head,obsLL(ibin))
