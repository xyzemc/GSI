...
!                .      .    .                                       .
! subprogram:	 module m_o3lNode
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2016-05-18
!
! abstract: class-module of obs-type o3lNode (ozone mixing ratio at pressure level)
!
! program history log:
...
! module interface:
  ...
  public:: o3lNode_typecast
  public:: o3lNode_nextcast
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(o3lNode) , intent(inout):: aNode
...
_ENTRY_(myname_)
  ...
  aNode%wij(1:8) = aNode%wij(1:8)*constoz
_EXIT_(myname_)
return
