...
!   2019-06-17 M. Morris - Update adjust_goescldobs to reject clear cloud obs over water at night
!   2019-12-05 M. Morris - Update adjust_goescldobs to reject ALL clear cloud cover obs at night
!
!   input argument list:
