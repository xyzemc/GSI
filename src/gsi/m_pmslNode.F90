...
!                .      .    .                                       .
! subprogram:	 module m_pmslNode
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2016-05-18
!
! abstract: class-module of obs-type pmslNode (pmsl)
!
! program history log:
...
! module interface:
  ...
  public:: pmslNode_typecast
  public:: pmslNode_nextcast
        interface pmslNode_typecast; module procedure typecast_ ; end interface
        interface pmslNode_nextcast; module procedure nextcast_ ; end interface
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(pmslNode), intent(inout):: aNode
