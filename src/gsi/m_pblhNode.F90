...
!                .      .    .                                       .
! subprogram:	 module m_pblhNode
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2016-05-18
!
! abstract: class-module of obs-type pblhNode (surface pblh)
!
! program history log:
...
! module interface:
  ...
  public:: pblhNode_typecast
  public:: pblhNode_nextcast
        interface pblhNode_typecast; module procedure typecast_ ; end interface
        interface pblhNode_nextcast; module procedure nextcast_ ; end interface
...
!-- cast a class(obsNode) to a type(pblhNode)
  use m_obsNode, only: obsNode
  implicit none
  type(pblhNode),pointer:: ptr_
...
!-- cast an obsNode_next(obsNode) to a type(pblhNode)
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(pblhNode), intent(inout):: aNode
...
subroutine obsNode_xwrite_(aNode,junit,jstat)
  implicit none
  class(pblhNode),intent(in):: aNode
