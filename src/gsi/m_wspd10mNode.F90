...
!     date:	 2016-05-18
!
! abstract: class-module of obs-type wspd10mNode (10m wind speed)
!
! program history log:
...
! module interface:
  ...
  type,extends(obsNode):: wspd10mNode
     ! private
  ...
  end type wspd10mNode

  public:: wspd10mNode_typecast
  public:: wspd10mNode_nextcast
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(wspd10mNode), intent(inout):: aNode
...
subroutine obsNode_xwrite_(aNode,junit,jstat)
  implicit none
  class(wspd10mNode),intent(in):: aNode
