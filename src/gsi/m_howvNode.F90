...
!                .      .    .                                       .
! subprogram:	 module m_howvNode
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2016-05-18
!
! abstract: class-module of obs-type howvNode (significant waver height)
!
! program history log:
...
! module interface:
  ...
  public:: howvNode_typecast
  public:: howvNode_nextcast
        interface howvNode_typecast; module procedure typecast_ ; end interface
        interface howvNode_nextcast; module procedure nextcast_ ; end interface
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(howvNode), intent(inout):: aNode
...
subroutine obsNode_xwrite_(aNode,junit,jstat)
  implicit none
  class(howvNode),intent(in):: aNode
