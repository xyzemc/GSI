...
! module interface:
  ...
  type,extends(obsNode):: uwnd10mNode
     ! private
  ...
  end type uwnd10mNode

  public:: uwnd10mNode_typecast
  public:: uwnd10mNode_nextcast
        interface uwnd10mNode_typecast; module procedure typecast_ ; end interface
        interface uwnd10mNode_nextcast; module procedure nextcast_ ; end interface
 
  character(len=*),parameter:: MYNAME="m_uwnd10mNode"
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(uwnd10mNode), intent(inout):: aNode
...
subroutine obsNode_xwrite_(aNode,junit,jstat)
  implicit none
  class(uwnd10mNode),intent(in):: aNode
