...
!                         procedures to gpsHeader_read_/gpsHeader_write_.  This
...
! module interface:
  ...
  public:: gpsNode_appendto
        interface gpsNode_appendto; module procedure appendto_ ; end interface
...
!-- append aNode to linked-list oLL
  ...
  implicit none
  type(gpsNode),pointer,intent(in):: aNode
