...
!   2020-02-20  martin   added parallel netCDF write support
!
...
!$$$ end documentation block
  ...
  public write_fv3_increment_para

  interface write_fv3_increment
     module procedure write_fv3_inc_
  end interface
  interface write_fv3_increment_para
     module procedure write_fv3_inc_para_
  end interface
...
!      Run TL model to fill sval
  ...
  subroutine write_fv3_inc_para_ (grd,sp_a,filename,mype_out,gfs_bundle,ibin)
...
!-------------------------------------------------------------------------
    ...
    character(len=120) :: my_name = 'WRITE_FV3INCR_PARALLEL'
   ...
   !******************************************************************************
   if ( mype == 0) then
      print *, 'ERROR: GSI attempting to write netCDF file in parallel'
...
#endif
  end subroutine write_fv3_inc_para_
