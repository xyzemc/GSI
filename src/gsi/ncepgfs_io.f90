...
!     ice in the 6-hour forecasting file (sfcf04 or sfcges) with globale_cycle.
!
...
!     variables
!     the new files (nstf04, nstges and nstanl) needs to be processed
!
!  2. When nst_gsi > 0, This routine generates the sfc & nst analysis files (sfcanl and nstanl) by
!     (1) reading sfcgcy (sfcf04 applied with global_cycle) and nstf04
...
!         water grids in GSI
!
!         nstf04_mem001  : 6-hour NSST forecast for each member
...
!  (001 to 080)
!      (1) reading sfcgcy_mem001 and nstf04_mem001 (1-80)
...
!      (1) read sfcgcy_mem001 and nstf04_mem001 to get the masks (GES and
