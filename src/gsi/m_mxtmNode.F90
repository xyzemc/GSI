...
!                .      .    .                                       .
! subprogram:	 module m_mxtmNode
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2016-05-18
!
! abstract: class-module of obs-type mxtmNode (daily maximum temperature)
!
! program history log:
...
! module interface:
  ...
  public:: mxtmNode_typecast
  public:: mxtmNode_nextcast
        interface mxtmNode_typecast; module procedure typecast_ ; end interface
        interface mxtmNode_nextcast; module procedure nextcast_ ; end interface
 
  character(len=*),parameter:: MYNAME="m_mxtmNode"
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(mxtmNode), intent(inout):: aNode
...
subroutine obsNode_xwrite_(aNode,junit,jstat)
  implicit none
  class(mxtmNode),intent(in):: aNode
