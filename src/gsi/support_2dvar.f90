...
!   2018-06-10  xzhang  - add 10 extra model variables for similarity theory application
...
! if (use_similarity_2dvar .and. jiter == miter) then !wrong place, since setup*
                                                      !routines are still used afer siganl
!    call mpi_barrier(mpi_comm_world,ierror)
!    call destroy_aux2dvarflds(mype)
! endif
...
!    nx=177                            !2p5 grid
!    ny=129                            !2p5 grid
!    alat18=16.828685_r_kind           !2p5 grid
!    elon18=291.804687_r_kind          !2p5 grid
!    da8=2500.000_r_kind               !2p5 grid
!    elonv8=9999._r_kind               !2p5 grid
!    alatan8=20.000000_r_kind          !2p5 grid
