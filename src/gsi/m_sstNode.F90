...
!                .      .    .                                       .
! subprogram:	 module m_sstNode
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2016-05-18
!
! abstract: class-module of obs-type sstNode (sea surface temperature)
!
! program history log:
...
! module interface:
  ...
  public:: sstNode_typecast
  public:: sstNode_nextcast
        interface sstNode_typecast; module procedure typecast_ ; end interface
        interface sstNode_nextcast; module procedure nextcast_ ; end interface
...
!-- cast a class(obsNode) to a type(sstNode)
  use m_obsNode, only: obsNode
  implicit none
  type(sstNode),pointer:: ptr_
...
!-- cast an obsNode_next(obsNode) to a type(sstNode)
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(sstNode),intent(inout):: aNode
