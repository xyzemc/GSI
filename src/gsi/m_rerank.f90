...
CONTAINS
  ...
  function rerank_2in1r4_(i2) result(i1)
    implicit none
    real(r_single),contiguous,target,dimension(:,:),intent(in):: i2
    real(r_single),contiguous,pointer,dimension(:):: i1
  ...
  function rerank_2in1r8_(i2) result(i1)
    implicit none
    real(r_double),contiguous,target,dimension(:,:),intent(in):: i2
    real(r_double),contiguous,pointer,dimension(:):: i1
  ...
  function rerank_3in1r4_(i3) result(i1)
    implicit none
    real(r_single),contiguous,target,dimension(:,:,:),intent(in):: i3
    real(r_single),contiguous,pointer,dimension(:):: i1
  ...
  function rerank_3in1r8_(i3) result(i1)
    implicit none
    real(r_double),contiguous,target,dimension(:,:,:),intent(in):: i3
    real(r_double),contiguous,pointer,dimension(:):: i1
...
!----
  function rerank_4in1r4_(i4) result(i1)
    implicit none
    real(r_single),contiguous,target,dimension(:,:,:,:),intent(in):: i4
    real(r_single),contiguous,pointer,dimension(:):: i1
  ...
  function rerank_4in1r8_(i4) result(i1)
    implicit none
    real(r_double),contiguous,target,dimension(:,:,:,:),intent(in):: i4
    real(r_double),contiguous,pointer,dimension(:):: i1
...
!----
  ...
  function rerank_1in3r4_(i1,mold,shape) result(i3)
    ...
    integer(i_kind),dimension(:,:,:),intent(in):: mold ! here to differentiate interface
    integer(i_kind),dimension(:),intent(in):: shape
    real(r_single),contiguous,pointer,dimension(:,:,:):: i3

    character(len=*),parameter:: myname_='rerank_1in3_single_'
    call assert_eq_(size(shape),3,myname_,'size(shape)==3')
    i3(1:shape(1),1:shape(2),1:shape(3)) => i1(1:shape(1)*shape(2)*shape(3))
  ...
  function rerank_1in3r8_(i1,mold,shape) result(i3)
    ...
    integer(i_kind),dimension(:,:,:),intent(in):: mold ! here to differentiate interface
    integer(i_kind),dimension(:),intent(in):: shape
    real(r_double),contiguous,pointer,dimension(:,:,:):: i3
...
!>>>
  function rerank_1in4r4_(i1,mold,shape) result(i4)
    ...
    integer(i_kind),dimension(:,:,:,:),intent(in):: mold ! here to differentiate interface
    integer(i_kind),dimension(:),intent(in):: shape
    real(r_single),contiguous,pointer,dimension(:,:,:,:):: i4

    character(len=*),parameter:: myname_='rerank_1in4_single_'
    call assert_eq_(size(shape),4,myname_,'size(shape)==4')
    i4(1:shape(1),1:shape(2),1:shape(3),1:shape(4)) => i1(1:shape(1)*shape(2)*shape(3)*shape(4))
  ...
  function rerank_1in4r8_(i1,mold,shape) result(i4)
    ...
    integer(i_kind),dimension(:,:,:,:),intent(in):: mold ! here to differentiate interface
    integer(i_kind),dimension(:),intent(in):: shape
    real(r_double),contiguous,pointer,dimension(:,:,:,:):: i4
