module m_vwnd10mNode
!$$$  subprogram documentation block
!                .      .    .                                       .
! subprogram:	 module m_vwnd10mlNode
!   prgmmr:	 Runhua Yang, following Jing Guo's m_wspd10mNode.  
!   Jing's  org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2017-03-15
!
! abstract: class-module of obs-type vwnd10mNode (10m u component)
!
! program history log:
...
!   2017-03-15  R Yang  - create code based on Jing Guo's m_wspd10mNode
!
...
! module interface:
  ...
  type,extends(obsNode):: vwnd10mNode
     ! private
  ...
  end type vwnd10mNode

  public:: vwnd10mNode_typecast
  public:: vwnd10mNode_nextcast
        interface vwnd10mNode_typecast; module procedure typecast_ ; end interface
        interface vwnd10mNode_nextcast; module procedure nextcast_ ; end interface
 
  character(len=*),parameter:: MYNAME="m_vwnd10mNode"
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(vwnd10mNode), intent(inout):: aNode
...
subroutine obsNode_xwrite_(aNode,junit,jstat)
  implicit none
  class(vwnd10mNode),intent(in):: aNode
