...
!                .      .    .                                       .
! subprogram:	 module m_mitmNode
!   prgmmr:	 j guo <jguo@nasa.gov>
!      org:	 NASA/GSFC, Global Modeling and Assimilation Office, 610.3
!     date:	 2016-05-18
!
! abstract: class-module of obs-type mitmNode (daily minimum temperature)
!
! program history log:
...
! module interface:
  ...
  public:: mitmNode_typecast
  public:: mitmNode_nextcast
        interface mitmNode_typecast; module procedure typecast_ ; end interface
        interface mitmNode_nextcast; module procedure nextcast_ ; end interface
...
subroutine obsNode_xread_(aNode,iunit,istat,diagLookup,skip)
  ...
  implicit none
  class(mitmNode), intent(inout):: aNode
...
subroutine obsNode_xwrite_(aNode,junit,jstat)
  implicit none
  class(mitmNode),intent(in):: aNode
