...
SUBROUTINE mpi_getobs(obspath, datestring, nobs_conv, nobs_oz, nobs_aod, nobs_sat, nobs_tot, &
    ...
    INTEGER(i_kind) nob, ierr, iozproc, iaodproc, isatproc, neig, &
            nobs_conv, nobs_oz, nobs_aod, nobs_sat, nobs_tot, nanal, nanalo
...
! get total number of conventional and sat obs for ensmean.
    ...
    IF(nproc == 0)PRINT *,'total diag nobs_conv, nobs_oz, nobs_aod, nobs_sat = ', nobs_convdiag, nobs_ozdiag, nobs_aoddiag, nobs_satdiag
