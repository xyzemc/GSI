...
!   2019-06-24  twu - add tl and ad partition for hwrf
!
!
...
!   sub cw2hydro
!   sub cw2hydro_ad
!   sub cw2hydro_tl_hwrf
!   sub cw2hydro_ad_hwrf
!
...
!
! program history log:
!   2017-07-19  T.-C. Wu - modified from cw2hydro_tl to use 6 instead of 2
!   hydrometeors
!
!   input argument list:
!    sval     - state variable
...
!
! program history log:
!   2017-07-19  T.-C. Wu - modified from cw2hydro_ad to use 6 instead of 2
!   hydrometeors
!
!   input argument list:
!     rval   - state variable
