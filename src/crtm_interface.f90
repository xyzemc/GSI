...
!       also, geometryinfo is not needed in crtm aod calculation
        ...
        !  geometryinfo(1)%sensor_zenith_angle = data_s(ilzen_ang)*rad2deg  ! local zenith angle        !orig
           geometryinfo(1)%sensor_zenith_angle = abs(data_s(ilzen_ang))*rad2deg  ! local zenith angle   !emily
