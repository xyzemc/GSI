...
if(DEFINED ENV{W3EMC_LIBd})
    ...
    set(W3EMC_INC4 $ENV{W3EMC_INC4} )
    message("Setting W3EMC library via environment variable ${W3EMC_LIB4}")
endif()

set( NO_DEFAULT_PATH )
if((NOT BUILD_W3EMC ) AND ( NOT DEFINED W3EMC_LIB4 ))
  if(DEFINED ENV{W3EMC_LIB} )
    set(W3EMC_LIB4 $ENV{W3EMC_LIB} )
    set(W3EMCINC $ENV{W3EMC_INC} )
    set(W3EMC_4_LIBRARY $ENV{W3EMC_LIB4} )
    set(W3EMC_INC4 $ENV{W3EMC_INC4} )
    message("W3EMC library ${W3EMC_LIB4} set via Environment variable")
...
if( NOT W3EMC_LIB4 ) # didn't find the library, so build it from source
    ...
    if( NOT DEFINED ENV{W3EMC_SRC} )
        ...
        set(W3EMC_INC4  "${CMAKE_BINARY_DIR}/include" CACHE STRING "W3EMC4 Include Directory")
    else()
    ...
    set( W3EMC_LIB4 ${w3emc} )
    set( W3EMC_4_LIBRARY ${w3emc} )
    set(W3EMCINC  "${CMAKE_BINARY_DIR}/include" CACHE STRING "W3EMC Include Directory")
    set(W3EMC_INC4  ${CMAKE_INCLUDE_4_OUTPUT_DIRECTORY} CACHE STRING "W3EMC4 Include Directory")
  if( CORE_BUILT )
    list( APPEND CORE_BUILT ${W3EMC_LIB4} )
    list( APPEND CORE_BUILT ${W3EMC_4_LIBRARY} )
  else()
    set( CORE_BUILT ${W3EMC_LIB4} )
    set( CORE_BUILT ${W3EMC_4_LIBRARY} )
  endif()
else( NOT W3EMC_LIB4 )
  if( CORE_LIBRARIES )
    list( APPEND CORE_LIBRARIES ${W3EMC_LIB4} )
  else()
    set( CORE_LIBRARIES ${W3EMC_LIB4} )
  endif()
endif( NOT W3EMC_LIB4 )
