...
adate0=`echo $global_nemsio_T62_adate | cut -c1-8`
...
if [ $ICO2 -gt 0 ] ; then
        ...
        yyyy=$(echo ${CDATE:-$global_nemsio_T62_adate}|cut -c1-4)
...
$ncp $global_nemsio_T62_obs/${prefix_obs}.osbuv8.${suffix}        ./sbuvbufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.goesfv.${suffix}        ./gsnd1bufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.1bamua.${suffix}        ./amsuabufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.1bamub.${suffix}        ./amsubbufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.1bhrs2.${suffix}        ./hirs2bufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.1bhrs3.${suffix}        ./hirs3bufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.1bhrs4.${suffix}        ./hirs4bufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.1bmhs.${suffix}         ./mhsbufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.1bmsu.${suffix}         ./msubufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.airsev.${suffix}        ./airsbufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.sevcsr.${suffix}        ./seviribufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.mtiasi.${suffix}        ./iasibufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.ssmit.${suffix}         ./ssmitbufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.amsre.${suffix}         ./amsrebufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.ssmis.${suffix}         ./ssmisbufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.gome.${suffix}          ./gomebufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.omi.${suffix}           ./omibufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.mlsbufr.${suffix}       ./mlsbufr
$ncp $global_nemsio_T62_obs/${prefix_obs}.eshrs3.${suffix}        ./hirs3bufrears
$ncp $global_nemsio_T62_obs/${prefix_obs}.esamua.${suffix}        ./amsuabufrears
$ncp $global_nemsio_T62_obs/${prefix_obs}.esamub.${suffix}        ./amsubbufrears
...
if [[ "$endianness" = "Big_Endian" ]]; then
   ...
   $ncp $global_nemsio_T62_ges/${prefix_sfc}.bf06                 ./sfcf06
   $ncp $global_nemsio_T62_ges/${prefix_sfc}.bf09                 ./sfcf09
elif [[ "$endianness" = "Little_Endian" ]]; then
   $ncp $global_nemsio_T62_ges/${prefix_sfc}.bf03.le              ./sfcf03
   $ncp $global_nemsio_T62_ges/${prefix_sfc}.bf06.le              ./sfcf06
   $ncp $global_nemsio_T62_ges/${prefix_sfc}.bf09.le              ./sfcf09
fi

if [[ "$endianness" = "Big_Endian" ]]; then
   $ncp $global_nemsio_T62_ges/${prefix_atm}.sgm3prep             ./sigf03
   $ncp $global_nemsio_T62_ges/${prefix_atm}.sgesprep             ./sigf06
   $ncp $global_nemsio_T62_ges/${prefix_atm}.sgp3prep             ./sigf09
elif [[ "$endianness" = "Little_Endian" ]]; then
   $ncp $global_nemsio_T62_ges/${prefix_atm}.sgm3prep.le          ./sigf03
   $ncp $global_nemsio_T62_ges/${prefix_atm}.sgesprep.le          ./sigf06
