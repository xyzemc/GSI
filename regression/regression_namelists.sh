...
export gsi_namelist="
 ...
 &OBSQC
   dfact=0.75,dfact1=3.0,noiqc=.true.,oberrflg=.false.,c_varqc=0.02,
   use_poq7=.true.,njqc=.false.,vqc=.true.,nvqc=.false.,hub_norm=.true.,aircraft_t_bc=.true.,biaspredt=1000.0,upd_aircraft=.true.,
   $OBSQC
 /
 &OBS_INPUT
   dmesh(1)=145.0,dmesh(2)=150.0,time_window_max=3.0,
...
::
 ...
 /
 &NST
   nst_gsi=3,nstinfo=4,fac_dtl=1,fac_tsl=1,zsea1=0,zsea2=5,
   $NST
 /
"
;;
...
export gsi_namelist="
 ...
 &SETUP
   ...
   oneobtest=.false.,retrieval=.false.,l_foto=.false.,
   use_pbl=.false.,use_compress=.true.,nsig_ext=12,gpstop=50.,
   use_gfs_nemsio=.true.,lrun_subdirs=.true.,use_readin_anl_sfcmask=.true.,
   ...
   l4densvar=.true.,ens_nstarthr=3,nhr_obsbin=1,nhr_assimilation=6,lwrite4danl=.false., tzr_qc=1,sfcnst_comb=.true.,
   $SETUP
 /
 &GRIDOPTS
   JCAP_B=$JCAP_B,JCAP=$JCAP,NLAT=$NLAT,NLON=$LONA,nsig=$LEVS,
 ...
 &OBSQC
   ...
   use_poq7=.true.,qc_noirjaco3_pole=.true.,vqc=.true.,nvqc=.false.,hub_norm=.true.,
...
export gsi_namelist="
 ...
 &OBSQC
   ...
   buddycheck_t=.false.,buddydiag_save=.false.,oberrflg=.true.,njqc=.true.,vqc=.false.,nvqc=.false.,hub_norm=.true.,
   $OBSQC
 /
 &OBS_INPUT
...
export gsi_namelist="
 ...
 /
 &OBSQC
   dfact=0.75,dfact1=3.0,noiqc=.true.,c_varqc=0.02,vadfile='prepbufr',oberrflg=.false.,njqc=.false.,vqc=.true.,nvqc=.false.,hub_norm=.true.,
 /
 &OBS_INPUT
...
export gsi_namelist="
 ...
 &OBSQC
   ...
   vadfile='prepbufr',oberrflg=.false.,njqc=.false.,vqc=.true.,nvqc=.false.,hub_norm=.true.,
 /
 &OBS_INPUT
...
export gsi_namelist="
 ...
 &OBSQC
   ...
   noiqc=.true.,c_varqc=0.02,vadfile='prepbufr',oberrflg=.false.,njqc=.false.,vqc=.true.,nvqc=.false.,hub_norm=.true.,
 /
 &OBS_INPUT
