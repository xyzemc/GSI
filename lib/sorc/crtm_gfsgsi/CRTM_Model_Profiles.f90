...
MODULE CRTM_Model_Profiles
  ...
  '$Id: CRTM_Model_Profiles.f90 1741 2008-02-12 17:11:21Z paul.vandelst@noaa.gov $'
  ...
  (/   0.0050_fp,    0.0161_fp,    0.0384_fp,    0.0769_fp,    0.1370_fp, &
       0.2244_fp,    0.3454_fp,    0.5064_fp,    0.7140_fp,    0.9753_fp, &
       1.2972_fp,    1.6872_fp,    2.1526_fp,    2.7009_fp,    3.3398_fp, &
       4.0770_fp,    4.9204_fp,    5.8776_fp,    6.9567_fp,    8.1655_fp, &
       9.5119_fp,   11.0038_fp,   12.6492_fp,   14.4559_fp,   16.4318_fp, &
      18.5847_fp,   20.9224_fp,   23.4526_fp,   26.1829_fp,   29.1210_fp, &
      32.2744_fp,   35.6505_fp,   39.2566_fp,   43.1001_fp,   47.1882_fp, &
      51.5278_fp,   56.1260_fp,   60.9895_fp,   66.1253_fp,   71.5398_fp, &
      77.2396_fp,   83.2310_fp,   89.5204_fp,   96.1138_fp,  103.0172_fp, &
     110.2366_fp,  117.7775_fp,  125.6456_fp,  133.8462_fp,  142.3848_fp, &
     151.2664_fp,  160.4959_fp,  170.0784_fp,  180.0183_fp,  190.3203_fp, &
     200.9887_fp,  212.0277_fp,  223.4415_fp,  235.2338_fp,  247.4085_fp, &
     259.9691_fp,  272.9191_fp,  286.2617_fp,  300.0000_fp,  314.1369_fp, &
     328.6753_fp,  343.6176_fp,  358.9665_fp,  374.7241_fp,  390.8926_fp, &
     407.4738_fp,  424.4698_fp,  441.8819_fp,  459.7118_fp,  477.9607_fp, &
     496.6298_fp,  515.7200_fp,  535.2322_fp,  555.1669_fp,  575.5248_fp, &
     596.3062_fp,  617.5112_fp,  639.1398_fp,  661.1920_fp,  683.6673_fp, &
     706.5654_fp,  729.8857_fp,  753.6275_fp,  777.7897_fp,  802.3714_fp, &
     827.3713_fp,  852.7880_fp,  878.6201_fp,  904.8659_fp,  931.5236_fp, &
     958.5911_fp,  986.0666_fp, 1013.9476_fp, 1042.2319_fp, 1070.9170_fp, &
    1100.0000_fp /)
