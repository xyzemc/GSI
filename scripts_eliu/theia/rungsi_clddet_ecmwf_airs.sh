...
#BSUB -W 02:00
#BSUB -cwd /gpfs/hps3/emc/da/noscrub/Emily.Liu/GSI_clddet/ProdGSI-clddet/scripts_eliu/logs
...
dir_root=/scratch4/NCEPDEV/da/save/Emily.Liu/GSI_clddet/ProdGSI-clddet
...
if [ $machine = "WCOSS_C" ]; then
   ...
   gsiexec=/gpfs/hps3/emc/da/noscrub/Emily.Liu/GSI_clddet/ProdGSI-clddet/exec/global_gsi.x
   DATA=$PTMP/$LOGNAME/tmp${JCAP}_sigmap/${exp}
   SAVDIR=$PTMP/$LOGNAME/out${JCAP}_sigmap/${exp}
   fixgsi=/gpfs/hps3/emc/da/noscrub/Emily.Liu/GSI_clddet/ProdGSI-clddet/fix
...
#  DATA=$PTMP/$LOGNAME/tmp${JCAP}_sigmap/${exp}
   DATA=$PTMP/$LOGNAME/GSI_clddet/tmp${JCAP}_sigmap/${exp}
#  SAVDIR=$PTMP/$LOGNAME/out${JCAP}_sigmap/${exp}
   SAVDIR=$PTMP/$LOGNAME/GSI_clddet/out${JCAP}_sigmap/${exp}

   gsiexec=${SAVE}/$LOGNAME/GSI_clddet/ProdGSI-clddet/exec/global_gsi.x
   fixgsi=${SAVE}/$LOGNAME/GSI_clddet/ProdGSI-clddet/fix
  #fixcrtm=$CRTM_FIX   # CRTM_FIX defined by crtm module
