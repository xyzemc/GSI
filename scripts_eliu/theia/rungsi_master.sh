...
#BSUB -W 02:00
#BSUB -cwd /gpfs/hps3/emc/da/noscrub/Emily.Liu/GSI_test/ProdGSI-master/scripts_eliu/logs
...
dir_root=/scratch4/NCEPDEV/da/save/Emily.Liu/GSI_test/ProdGSI-master
...
if [ $machine = "WCOSS_C" ]; then
   ...
   gsiexec=/gpfs/hps3/emc/da/noscrub/Emily.Liu/GSI_test/ProdGSI-master/exec/global_gsi.x
...
#  SAVDIR=$PTMP/$LOGNAME/out${JCAP}_sigmap/${exp}
   ...
   gsiexec=${SAVE}/$LOGNAME/GSI_test/ProdGSI-master/exec/global_gsi.x
   fixgsi=${SAVE}/$LOGNAME/GSI_test/ProdGSI-master/fix
  #fixcrtm=$CRTM_FIX   # CRTM_FIX defined by crtm module
