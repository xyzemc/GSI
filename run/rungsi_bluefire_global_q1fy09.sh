...
# Copy observational data to $tmpdir
 ${NPC:-cp} /ptmp/mhu/blueice/t8/obs/gdas1.t00z.prepbufr.nr ./prepbufr
...
## $ncp $datges/wrfinput_west_mass_d01_bi     ./wrf_inout
 ${NPC:-cp} /ptmp/mhu/blueice/t8/t8_case_2007081500/wrfinput_d01_2007081500   ./wrf_inout
...
# Run gsi under Parallel Operating Environment (poe) on NCAR IBM
