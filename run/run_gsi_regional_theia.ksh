...
# GSI_EXE  = path and name of the gsi executable 
  ...
  WORK_ROOT=/scratch3/BMC/wrfruc/mhu/code/comGSI/trunk/trunk/run/testarw
  OBS_ROOT=/scratch3/BMC/wrfruc/mhu/code/comGSI/data/20140617/obs
  PREPBUFR=${OBS_ROOT}/nam.t${HH}z.prepbufr.tm00.nr
  BK_ROOT=/scratch3/BMC/wrfruc/mhu/code/comGSI/data/20140617/bk
  BK_FILE=${BK_ROOT}/wrfinput_d01.${ANAL_TIME}
  CRTM_ROOT=/scratch3/BMC/wrfruc/mhu/code/comGSI/data/crtm_2.2.3
  GSI_ROOT=/scratch3/BMC/wrfruc/mhu/code/comGSI/trunk/trunk
