...
!        used and just assigned to COMPACTED_SOIL.
  ...
  integer(i_kind),parameter,dimension(12):: mday=(/0,31,59,90,120,151,&
...
!    Turn off antenna correction
     options(1)%antenna_correction = 0
...
!       geometryinfo(1)%Time = float(obs_time(1)) + float(day_of_year)/(365.0+leap_day)
