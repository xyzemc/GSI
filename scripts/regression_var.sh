...
#   export queue=dev
   ...
   export gsisrc=$basedir/trunk/src
   export gsiexec_updat=$basedir/gsi/xsu_obr/src/global_gsi
#   export gsiexec_updat=$basedir/gsi/trunk/src/global_gsi
   export gsiexec_contrl=$basedir/gsi/trunk/src/global_gsi
   export enkfexec_updat=$basedir/gsi/xsu_obr/src/enkf/global_enkf
#   export enkfexec_updat=$basedir/gsi/trunk/src/enkf/global_enkf
   export enkfexec_contrl=$basedir/gsi/trunk/src/enkf/global_enkf
   export fixgsi=$basedir/gsi/xsu_obr/fix
   export scripts=$basedir/gsi/xsu_obr/scripts
