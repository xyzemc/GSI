...
if [[ "$machine" = "Theia" ]]; then
   ...
   if [ "$debug" = ".false." ]; then
      /bin/sh sub_wcoss -a GDAS-T2O -j $global_T62_updat_exp1 -q $queue -p 16/2/ -r /1 -t 0:55:00 $scripts/global_T62.sh
      ...
      rm -f return_code_global_3dvar.out
      /bin/sh sub_wcoss -a GDAS-T2O -j $global_T62_updat_exp2 -q $queue -p 9/8/ -r /2 -t 0:55:00 $scripts/global_T62.sh
      ...
      rm -f return_code_global_3dvar.out
      /bin/sh sub_wcoss -a GDAS-T2O -j $global_T62_contrl_exp1 -q $queue -p 16/2/ -r /1 -t 0:55:00 $scripts/global_T62.sh
      ...
      rm -f return_code_global_3dvar.out
      /bin/sh sub_wcoss -a GDAS-T2O -j $global_T62_contrl_exp2 -q $queue -p 9/8/ -r /2 -t 0:55:00 $scripts/global_T62.sh
