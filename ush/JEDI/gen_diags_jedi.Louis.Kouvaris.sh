...
GSIDir=/scratch4/NCEPDEV/da/save/Louis.Kouvaris/ProdGSI/
gsiexec=/scratch4/NCEPDEV/da/save/Louis.Kouvaris/ProdGSI/build/bin/gsi.x
nccat=/scratch4/NCEPDEV/da/save/Louis.Kouvaris/ProdGSI/build/bin/nc_diag_cat_serial.x
...
/home/Louis.Kouvaris/bin/slurm.sh
