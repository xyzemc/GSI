...
#   separate_arguments(_MPI_COMPILER_WRAPPER_OPTIONS UNIX_COMMAND "${MPI_${LANG}_COMPILER_FLAGS}")
    separate_arguments(_MPI_COMPILER_WRAPPER_OPTIONS "${MPI_${LANG}_COMPILER_FLAGS}")
  else()
    separate_arguments(_MPI_COMPILER_WRAPPER_OPTIONS UNIX_COMMAND "${MPI_COMPILER_FLAGS}")
  endif()
  execute_process(
...
function (_MPI_interrogate_compiler lang)
  ...
  if (NOT MPI_ALL_INCLUDE_PATHS)
    ...
    if(MPI_INCDIRS_COMPILER_RETURN)
      separate_arguments(MPI_ALL_INCLUDE_PATHS UNIX_COMMAND "${MPI_INCDIRS_CMDLINE}")
    endif()
  endif()
  ...
  if (NOT MPI_ALL_LINK_PATHS)
    ...
    if(MPI_LIBDIRS_COMPILER_RETURN)
      separate_arguments(MPI_ALL_LINK_PATHS UNIX_COMMAND "${MPI_LIBDIRS_CMDLINE}")
    endif()
  endif()
...
if(NOT MPI_IGNORE_LEGACY_VARIABLES)
  foreach (LANG IN ITEMS C CXX)
    ...
    if(MPI_${LANG}_COMPILE_FLAGS)
      separate_arguments(MPI_SEPARATE_FLAGS UNIX_COMMAND "${MPI_${LANG}_COMPILE_FLAGS}")
