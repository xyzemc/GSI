function(set_LIBRARY_UTIL_Intel)
    ...
    set(BUFR_Fortran_FLAGS "-O2 -r8 -fp-model strict -traceback -xSSE2  -O3 -axCORE-AVX2 ${HOST_FLAG} ${OMPFLAG} " CACHE INTERNAL "" )
    ...
    set (NEMSIO_Fortran_FLAGS " -O2 -convert big_endian -free -assume byterecl -xSSE2 -fp-model strict -traceback ${HOST_FLAG} -g ${MKL_FLAG} ${OMPFLAG} " CACHE INTERNAL "" )
    set (SFCIO_Fortran_FLAGS "  -O2 -convert big_endian -free -assume byterecl  -xSSE2  -fp-model strict -traceback ${HOST_FLAG} -g ${MKL_FLAG} ${OMPFLAG} " CACHE INTERNAL "" )
    set (SIGIO_Fortran_FLAGS "  -O2 -convert big_endian -free -assume byterecl  -xSSE2  -fp-model strict -traceback ${HOST_FLAG} -g ${MKL_FLAG} ${OMPFLAG} " CACHE INTERNAL "" )
...
function(set_GSI_ENKF_Intel)
    ...
    set(GSI_Fortran_FLAGS ${GSI_Platform_FLAGS} CACHE INTERNAL "Full GSI Fortran FLAGS" )
    set(ENKF_Fortran_FLAGS ${ENKF_Platform_FLAGS} CACHE INTERNAL "Full ENKF Fortran FLAGS" )
    message("HEY!!! platform flags are ${GSI_Fortran_FLAGS}")
