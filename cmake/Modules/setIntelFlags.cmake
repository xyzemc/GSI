function(set_LIBRARY_UTIL_Intel)
    ...
    set(BUFR_Fortran_FLAGS "-O2 -r8 -fp-model strict -traceback -O3 -xHOST -axCORE-AVX2 ${HOST_FLAG} ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    ...
    set (NEMSIO_Fortran_FLAGS " -O2 -convert big_endian -free -assume byterecl -fp-model strict -xHOST -traceback ${HOST_FLAG} -g ${MKL_FLAG} ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    set (SFCIO_Fortran_FLAGS "  -O2 -convert big_endian -free -assume byterecl -fp-model strict -xHOST -traceback ${HOST_FLAG} -g ${MKL_FLAG} ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    set (SIGIO_Fortran_FLAGS "  -O2 -convert big_endian -free -assume byterecl -fp-model strict -xHOST -traceback ${HOST_FLAG} -g ${MKL_FLAG} ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    ...
    set (W3NCO_Fortran_FLAGS " -O3 -auto -assume nocc_omp -i4  -r8 -convert big_endian -assume byterecl -fp-model strict ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" ) # CCT modified to make it work
    ...
    set(RADAREMUL_Fortran_FLAGS "-O3 -convert big_endian" CACHE INTERNAL "" )
