function(set_LIBRARY_UTIL_Intel)
    ...
    set(BUFR_Fortran_FLAGS "-O2 -r8 -fp-model strict -traceback -xHOST  -O3 -axCORE-AVX2 ${HOST_FLAG} ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    ...
    set (NEMSIO_Fortran_FLAGS " -O2 -convert big_endian -free -assume byterecl -xHOST -fp-model strict -traceback ${HOST_FLAG} -g ${MKL_FLAG} ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    set (SFCIO_Fortran_FLAGS "  -O2 -convert big_endian -free -assume byterecl  -xHOST  -fp-model strict -traceback ${HOST_FLAG} -g ${MKL_FLAG} ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    set (SIGIO_Fortran_FLAGS "  -O2 -convert big_endian -free -assume byterecl  -xHOST  -fp-model strict -traceback ${HOST_FLAG} -g ${MKL_FLAG} ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
...
function (set_GSI_ENKF_Debug_Intel)
    ...
    set(ENKF_Fortran_FLAGS "-O0 ${HOST_FLAG} -warn all -implicitnone -traceback -g -debug all -check all,noarg_temp_created -fp-model source -convert big_endian -assume byterecl -D_REAL8_ ${MPI3FLAG} ${OpenMP_Fortran_FLAGS}" CACHE INTERNAL "")
    #Common debug flags
