function(set_LIBRARY_UTIL_Intel)
    ...
    set (W3NCO_Fortran_FLAGS " -O3 -auto -assume nocc_omp -i  -r8 -convert big_endian -assume byterecl -fp-model strict ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
...
function(set_LIBRARY_UTIL_Debug_Intel)
    ...
    set(BUFR_Fortran_FLAGS " -c -g -traceback -O3 -r8 " CACHE INTERNAL "" )
    set(BUFR_C_FLAGS "-g -traceback -DUNDERSCORE -O3 -DDYNAMIC_ALLOCATION -DNFILES=32 -DMAXCD=250 -DMAXNC=600 -DMXNAF=3" CACHE INTERNAL "" )
    set(BUFR_Fortran_PP_FLAGS " -P -traditional-cpp -C  " CACHE INTERNAL "" )
    set(CRTM_Fortran_FLAGS " -convert big_endian -free -assume byterecl  -fp-model strict -traceback -g ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    set(SFCIO_Fortran_FLAGS "  -convert big_endian -free -assume byterecl -fp-model strict -traceback  -g ${MKL_FLAG} ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    set(SIGIO_Fortran_FLAGS "  -convert big_endian -free -assume byterecl -fp-model strict -traceback  -g ${MKL_FLAG} ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    ...
    set(NEMSIO_Fortran_FLAGS " -convert big_endian -free -assume byterecl -fp-model strict -traceback  -g ${MKL_FLAG} ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
    set(W3NCO_Fortran_FLAGS " -g -auto -assume nocc_omp -i  -r8 -convert big_endian -assume byterecl -fp-model strict ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "" )
