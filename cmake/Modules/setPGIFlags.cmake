function (setPGI)
  ...
  if( (BUILD_RELEASE) OR (BUILD_PRODUCTION) )
    ...
    set(GSI_Fortran_FLAGS "-Minform=inform -O1 -byteswapio -DPOUND_FOR_STRINGIFY -D_REAL8_ ${GSDCLOUDOPT} -mp -Mfree" CACHE INTERNAL "")
    ...
    set(Fortran_FLAGS "" CACHE INTERNAL "")
    set(GSI_Fortran_FLAGS "-Minform=inform -g -traceback -byteswapio -DPOUND_FOR_STRINGIFY -D_REAL8_ ${GSDCLOUDOPT} -mp -Mfree" CACHE INTERNAL "")
