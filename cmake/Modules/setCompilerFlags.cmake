...
#     set(GSI_Fortran_FLAGS "-traceback -fp-model source -assume byterecl -convert big_endian -implicitnone  -D_REAL8_ ${OMPFLAG} ${MPI_Fortran_COMPILE_FLAGS}" PARENT_SCOPE)
      ...
      set(ENKF_Fortran_FLAGS "-O3 -xHOST -fp-model source -convert big_endian -assume byterecl -implicitnone  -DGFS -D_REAL8_ -DMPI3 ${OMPFLAG}" PARENT_SCOPE)
    ...
    elseif( HOST-Luna OR HOST-Surge )
      ...
      set(ENKF_Fortran_FLAGS "-O3 -fp-model source -convert big_endian -assume byterecl -implicitnone  -DGFS -D_REAL8_ -DMPI3 ${OMPFLAG} " PARENT_SCOPE)
      set(UTIL_Fortran_FLAGS "-O3 -fp-model source -convert big_endian -assume byterecl -implicitnone  -DWRF -D_REAL8_ ${OMPFLAG} " PARENT_SCOPE)
      set (BACIO_Fortran_FLAGS "-O3 -free -assume nocc_omp " PARENT_SCOPE )
      ...
      set(ENKF_Fortran_FLAGS "-O3 -xHOST -warn all -implicitnone -traceback -fp-model strict -convert big_endian -DGFS -D_REAL8_ -DMPI3 ${OMPFLAG}" PARENT_SCOPE)
...
#   set (CRTM_Fortran_FLAGS " -assume byterecl -convert big_endian -O3 -fp-model source -free -assume byterecl " PARENT_SCOPE )
    ...
    if(( HOST-Tide ) OR ( HOST-Gyre ))
      set(GSI_Fortran_FLAGS "-DPOUND_FOR_STRINGIFY -O3 -fp-model source -convert big_endian -assume byterecl -implicitnone -mcmodel medium -shared-intel -g -traceback -debug -ftrapuv -check all,noarg_temp_created -fp-stack-check -fstack-protector -warn all,nointerfaces -convert big_endian -implicitnone -D_REAL8_ ${OMPFLAG} ${MPI_Fortran_COMPILE_FLAGS}" PARENT_SCOPE)
      set(ENKF_Fortran_FLAGS "-g -O0 -fp-model source -convert big_endian -assume byterecl -implicitnone -warn all -traceback -debug all -check all,noarg_temp_created -implicitnone  -DGFS -D_REAL8_ -DMPI3 ${OMPFLAG}" PARENT_SCOPE)
      ...
      set(ENKF_Fortran_FLAGS "-O0 -xHOST -warn all -implicitnone -traceback -g -debug full -fp-model strict -convert big_endian -D_REAL8_ -DMPI3 ${OMPFLAG}" PARENT_SCOPE)
