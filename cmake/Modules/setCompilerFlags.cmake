function(setWCOSSIntelFlags)
  if( (BUILD_RELEASE) OR (BUILD_PRODUCTION) )
      ...
      set(UTIL_Fortran_FLAGS "-O3 -fp-model source -convert big_endian -assume byterecl -implicitnone  -DWRF -D_REAL8_ ${OMPFLAG}" CACHE INTERNAL "")
      ...
      set(ENKF_Fortran_FLAGS "-g -O0 -fp-model source -convert big_endian -assume byterecl -implicitnone -warn all -traceback -debug all -check all,noarg_temp_created -implicitnone  -DGFS -D_REAL8_ ${MPI3FLAG} ${OMPFLAG}" CACHE INTERNAL "")
      set(UTIL_Fortran_FLAGS "-g -O0 -fp-model source -convert big_endian -assume byterecl -implicitnone -warn all -traceback -debug all -check all,noarg_temp_created -implicitnone  -DWRF -D_REAL8_ ${OMPFLAG}" CACHE INTERNAL "")
      set(UTIL_COM_Fortran_FLAGS "-g -O0 -fp-model source -convert big_endian -assume byterecl -implicitnone -warn all -traceback -debug all" CACHE INTERNAL "")
      set (BACIO_Fortran_FLAGS "-g -free -assume nocc_omp " CACHE INTERNAL "" )
  endif()
endfunction(setWCOSSIntelFlags)
function(setWCOSS_DIntelFlags)
  if( (BUILD_RELEASE) OR (BUILD_PRODUCTION) )
      ...
      set(GSI_Fortran_FLAGS "-DPOUND_FOR_STRINGIFY -O0 -fp-model source -convert big_endian -assume byterecl -implicitnone -mcmodel medium -shared-intel -g -traceback -debug -ftrapuv -check all,noarg_temp_created -fp-stack-check -fstack-protector -warn all,nointerfaces -convert big_endian -implicitnone -D_REAL8_ ${OMPFLAG} ${MPI_Fortran_COMPILE_FLAGS}" CACHE INTERNAL "")
      set(GSI_LDFLAGS "${OMPFLAG} ${MKL_FLAG}" CACHE INTERNAL "")
      set(ENKF_Fortran_FLAGS "-g -O0 -fp-model source -convert big_endian -assume byterecl -implicitnone -warn all -traceback -debug all -check all,noarg_temp_created -implicitnone  -DGFS -D_REAL8_ ${OMPFLAG}" CACHE INTERNAL "")
      set(UTIL_Fortran_FLAGS "-g -O0 -fp-model source -convert big_endian -assume byterecl -implicitnone -warn all -traceback -debug all -check all,noarg_temp_created -implicitnone  -DWRF -D_REAL8_ ${OMPFLAG}" CACHE INTERNAL "")
      set(BACIO_Fortran_FLAGS "-g -free -assume nocc_omp " CACHE INTERNAL "" )
  endif()
endfunction(setWCOSS_DIntelFlags)
...
function (setIntel)
  ...
  if( (BUILD_RELEASE) OR (BUILD_PRODUCTION) )
    ...
    elseif ( HOST-WCOSS_D )
      setWCOSS_DIntelFlags()
    elseif ( HOST-WCOSS_D )
      set(GSI_Fortran_FLAGS "-DPOUND_FOR_STRINGIFY -fp-model strict -assume byterecl -convert big_endian -implicitnone -D_REAL8_ ${OMPFLAG} ${MPI_Fortran_COMPILE_FLAGS} -O3" PARENT_SCOPE)
      set(GSI_LDFLAGS "${OMPFLAG} ${MKL_FLAG}" PARENT_SCOPE)
 
      set(ENKF_Fortran_FLAGS "-O3 -fp-model strict -convert big_endian -assume byterecl -implicitnone  -DGFS -D_REAL8_ ${OMPFLAG} " PARENT_SCOPE)
      set(UTIL_Fortran_FLAGS "-O3 -fp-model strict -convert big_endian -assume byterecl -implicitnone  -DWRF -D_REAL8_ ${OMPFLAG} " PARENT_SCOPE)
      set (BACIO_Fortran_FLAGS "-O3 -free -assume nocc_omp " PARENT_SCOPE )
      set (BUFR_Fortran_FLAGS " -c -g -traceback -O3 -axCORE-AVX2 -r8 " PARENT_SCOPE )
      set (BUFR_C_FLAGS "-DSTATIC_ALLOCATION -DUNDERSCORE -DNFILES=32 -DMAXCD=250 -DMAXNC=600 -DMXNAF=3" PARENT_SCOPE )
