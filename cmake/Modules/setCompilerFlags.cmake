function (setIntel)
  ...
  if( (BUILD_RELEASE) OR (BUILD_PRODUCTION) )
    ...
    elseif ( HOST-Venus OR HOST-Mars )
      set(GSI_Fortran_FLAGS "-traceback -DPOUND_FOR_STRINGIFY -fp-model strict -assume byterecl -convert big_endian -implicitnone -D_REAL8_ ${OMPFLAG} ${MPI_Fortran_COMPILE_FLAGS} -O3" PARENT_SCOPE)
