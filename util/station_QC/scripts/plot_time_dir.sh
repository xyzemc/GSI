...
#
# usage: plot_time_dir.sh dtype itype sdate edate datadir WSHOME WSUSER WS scripts gscripts
#
...
export time_dir=$WSHOME/web/global/time/$dtype
...
#--- preparation
  ...
  tmpdir=/ptmpp1/$USER/gsiqc3/plottime_${dtype}_dir
