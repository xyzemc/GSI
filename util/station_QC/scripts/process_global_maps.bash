...
# Script name: process_global_maps.bash
# Script description:this script is a driver to make documents for google map display
...
#
# usage: process_global_maps.bash ppdate CTL_DIR WSHOME WSUSER WS sfctype sondtype uvsfctype uvsondtype bashdir
#
