...
# Script name: plot_vert.sh
# Script description:this script plots vertical profile of O-A and O-B statistics 
...
#
# usage: plot_vert.sh dtype sdate edate datadir WSHOME WSUSER WS scripts gscripts dtim
#
