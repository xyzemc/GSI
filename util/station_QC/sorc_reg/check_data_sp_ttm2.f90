...
!   compare their values  
      ...
      subroutine check_data_sp_ttm2(ntm,dtype,filetype,tm,filetm,n,nd,nd2,nk,stdid,&
      ...
      real(4),dimension(nk,nd2) :: break_out2,break_out,break_input
      real(4),dimension(nk,nd) :: std_out,rmean_out
      real(4),dimension(nk,2) :: tno_out,tno_input
      real(4),dimension(nk,nd) :: std_input,rmean_input
      real(4),dimension(nk,nd2) :: xmed_out,xmed_input 
