...
!   compare their values  
      ...
      subroutine check_list_sfc_qlyrej(dtype,filetype,n,nd,nd2,ncount1,ncount2,index1,index2,&
    ...
    do j=1,ncount2
       if( trim(stdid1(index1,i)) == trim(stdid1(index2,j))) then
          if(tdata_no1(index1,i,1) >=1.0 .and. tdata_no1(index2,j,1) >=1.0) then 
             if(tdata_no1(index1,i,2) >tdata_no1(index2,j,2)) then
