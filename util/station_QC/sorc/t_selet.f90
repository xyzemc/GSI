...
!  of the surface pressure stations
        ...
        subroutine t_selet(dtype,nk,iqcflg)

    use crite_constnt,only: t2_c_rm,t2_c_std1
...
200 format(2x,a8,i8,3f8.2)
   ...
   Print *,'t_selet:,dtype,ndata,n_qly,n_sup,n_bias,n_rej,n_other'
       Print *,'t_selet:',dtype,ndata,n_qly,n_sup,n_bias,n_rej,n_other
