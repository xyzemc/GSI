...
#
# usage: plot_time.sh dtype itype sdate edate datadir WSHOME WSUSER WS scripts gscripts ttm
#
...
# ttm: regional anaylysis delay time
...
export WSMAP=${time}
  ...
  tmpdir=/ptmpp1/$USER/gsiqc3/plottime_reg_$dtype/${tm}
