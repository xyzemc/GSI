...
# Script name: plot_time_obs_reg.sh
# Script description:this script plots time series of regional observation statistics
...
#
# usage: plot_time_obs.sh dtype itype sdate edate datadir WSHOME WSUSER WS scripts gscripts ttm
#
...
#sdate=2011010100
#edate=2011033118
#WSHOME=/export/lnx42/emc-lw-xsu/gsiqc3
#WSUSER=emc-lw-xsu
#WS=lnx42.ncep.noaa.gov
...
#export time_obs=$WSHOME/web/regional/time/$dtype
...
for tm in  ${ttm} 
do
export time_obs=$WSHOME/web/regional/time/${tm}/$dtype
export WSMAP=${time_obs}


  tmpdir=/ptmpp1/$USER/gsiqc3/plottime_reg_${dtype}_obs_${tm}
