...
# Script name: plot_time_obs_dir_reg.sh
...
# Abstract: this script plots time series of regional wind direction observation statistics

# Script history log:
# 2018-09-21: X. Su  clean up comment lines and document the script
#
# usage: plot_time_obs_dir.sh dtype itype sdate edate datadir WSHOME WSUSER WS scripts gscripts ttm
#
