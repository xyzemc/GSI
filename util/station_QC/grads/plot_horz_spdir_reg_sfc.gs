...
if (dtype =uv224); nhe=2; nz=43;endif
...
'page'
'c'
levz.1=surface;levz.2=975;levz.3=950;levz.4=925;levz.5=900;levz.6=875
...
'draw title 'dtype'_spd,Bias(O-B) at reg. 'he',avgd over 'rdate 
...
'draw title 'dtype'_spd,Bias(O-A) at reg. 'he',avgd over 'rdate 
