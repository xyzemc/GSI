...
'set ylopts 98'
if(he = 1)
*if(plotfile = t120); 'set lat 0 40';'set lon 0 80';endif
 'set lat -90 90';'set lon 0 360'
endif
if(he = 2)
*if(plotfile = t120); 'set lat 0 40';'set lon 0 80';endif
 'set lat 0 40';'set lon 0 80'
endif
if(he = 3)
...
if(he = 4)
*if(plotfile = t120); 'set lat 0 40';'set lon 80 160';endif
 'set lat 0 40';'set lon 80 160'
endif
if(he = 5)
*if(plotfile = t120); 'set lat 30 75';'set lon 80 160';endif
'set lat 30 75';'set lon 80 160'
endif
if(he = 6)
...
*if(plotfile = t120); 'set lat -35 30';'set lon 0 120';endif
 'set lat -35 30';'set lon 0 120'
endif
if(he = 10)
*if(plotfile = t120); 'set lat -65 0';'set lon 120 240';endif
'set lat -65 0';'set lon 120 240'
endif
if(he = 11)
