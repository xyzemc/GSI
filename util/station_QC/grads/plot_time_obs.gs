...
plottime(ix,nz,stationid,lon,lat,hgt,styp,dtype,sdate,debug)
 
ix=ix+1
endwhile

function plottime(ix,nz,stationid,lon,lat,hgt,styp,dtype,sdate,debug) 
...
'set cstyle 3'
'd obs-obg'
'draw string '1.0' 'ystring' 'dtype',stid('ix'):'stationid',lat:'lat',lon:'lon',st. height:'hgt',levs:'levz.rz 
rz=rz+1
if=if+1
endwhile

rrz=rz-1
*outfile=dtype'_obs_'ix'_'stationid'_'levz.rz'.png'
outfile=dtype'_obs_'stationid'_'levz.rrz'.png'
