...
MODULE RadDiag_Data_Define
  ...
  TYPE :: RadDiag_Data_Scalar_type
    ...
    REAL(r_radstat) :: qcdiag1    = ZERO  ! ir=cloud fraction, mw=cloud liquid water clwp_amsua
    REAL(r_radstat) :: qcdiag2    = ZERO  ! ir=cloud top pressure, mw=total column water clw_guess
