...
!  of the surface pressure stations
        ...
        subroutine w_selet_sfc(dtype,iqcflg)

!!!    get criteria from crite_constnt module
  
      use crite_constnt,only: wd_c_rm,wd_c_std,ws_c_rm,ws_c_std
...
deallocate(tmp2)
       ...
       Print *,'w_selet_sfc:,dtype,ndata,n_norm,n_qly,n_sup,n_rej_dir,n_rej_sp,n_other'
       Print *,'w_selet_sfc:',dtype,ndata,n_norm,n_qly,n_sup,n_rej_dir,n_rej_sp,n_other
