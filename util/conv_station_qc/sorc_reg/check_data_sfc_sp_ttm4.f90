...
!   compare their values  
      ...
      subroutine check_data_sfc_sp_ttm4(ntm,dtype,filetype,tm,filetm,n,nd,nd2,stdid,&
      ...
      real(4),dimension(nd) :: std_out3,rmean_out3
      ...
      real(4),dimension(nd2) :: break_out2,break_out3 
