...
!  statistics
    ...
    subroutine compare_list_sp(ntm,dtype,tm,fileexist,filetype,nd,nd2,nk) 
...
!      tm(5)='12'
      ...
      print *, 'main_compare_list_sp:',filetm_other(1,1),filetm_other(1,2) 
      print *, filetm_other(1,3) 
       ...
       do i=1,ndata
          ...
          enddo 
         print *,'compare_list_sp:filetm1=',filetm1,nd,nd2
         print *,'compare_list_sp:filetm_o=',filetm_o(1),filetm_o(2),&
                  filetm_o(3)
            
         if (ntm ==2) then
            call check_data_sp_ttm2(ntm,dtype,filetype,filetm1,filetm_o,200,nd,nd2,nk,stdid,cid,rmean,&
                   std,std_no,tdata_no,xmed,break,iqcflg,ncount)
         else if (ntm ==3) then
            call check_data_sp_ttm3(ntm,dtype,filetype,filetm1,filetm_o,200,nd,nd2,nk,stdid,cid,rmean,&
                   std,std_no,tdata_no,xmed,break,iqcflg,ncount)
         else if (ntm ==4) then
            call check_data_sp_ttm4(ntm,dtype,filetype,filetm1,filetm_o,200,nd,nd2,nk,stdid,cid,rmean,&
                   std,std_no,tdata_no,xmed,break,iqcflg,ncount)
         endif
            ...
            nrecord(i)=ncount
           print *,'compare_list_sp:filetm1=',filetm1
           print *,nrecord(i)
          print *,'compare_list_sp: allthelist'
           do j =1,ncount
...
320  format(8f8.2)
     ...
     if(ndata ==1) then
        ...
        call check_list_sp(dtype,filetype,200,nd,nd2,nk,nstat2,nstat,2,1,&
        ...
        iqcflg(1:nstat,1:nk)=iqcflgout(1,1:nstat,1:nk)        
        call check_list_sp(dtype,filetype,200,nd,nd2,nk,nstat3,nstat,3,1,&
             stdidout,cidout,rmeanout,stdout,xmedout,&
             breakout,std_noout,tdata_noout,iqcflgout,&
             stdid,cid,rmean,std,xmed,break,std_no,tdata_no,iqcflg,n)
        nstat=n
        ...
        tdata_noout(1,1:nstat,1:nk,1:2)=tdata_no(1:nstat,1:nk,1:2)
        iqcflg(1:nstat,1:nk)=iqcflgout(1,1:nstat,1:nk)        
        call check_list_sp(dtype,filetype,200,nd,nd2,nk,nstat4,nstat,4,1,&
             stdidout,cidout,rmeanout,stdout,xmedout,&
             breakout,std_noout,tdata_noout,iqcflgout,&
             stdid,cid,rmean,std,xmed,break,std_no,tdata_no,iqcflg,n)
        nstat=n
        ...
        tdata_noout(1,1:nstat,1:nk,1:2)=tdata_no(1:nstat,1:nk,1:2)
        iqcflg(1:nstat,1:nk)=iqcflgout(1,1:nstat,1:nk)        
        call check_list_sp(dtype,filetype,200,nd,nd2,nk,nstat5,nstat,5,1,&
             stdidout,cidout,rmeanout,stdout,xmedout,&
             breakout,std_noout,tdata_noout,iqcflgout,&
             stdid,cid,rmean,std,xmed,break,std_no,tdata_no,iqcflg,n)
        nstat=n
