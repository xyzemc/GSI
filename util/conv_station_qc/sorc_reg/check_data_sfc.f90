...
!   compare their values  
      ...
      subroutine check_data_sfc_tm4(ntm,dtype,filetype,tm,filetm,n,nd,nd2,stdid,&
...
!              print *,'2,check_data_sfc:',tm2,rmean_input(1),std_input(1),std_no_input
              call check_std_sfc(dtype,tm3,filetype,nd,nd2,stdid_input,rmean_input,std_input,&   
                        std_no_input,xmed_input,break_input,tno_input,iqcinput,& 
