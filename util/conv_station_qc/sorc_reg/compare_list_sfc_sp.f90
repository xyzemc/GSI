...
!  statistics
    ...
    subroutine compare_list_sfc_sp(ntm,dtype,tm,fileexist,filetype,nd,nd2) 
    ...
    character(2),dimension(ntm) :: tm,filetm,filetm_o 
...
!      tm(4)='12'
      ...
      print *, 'compare_list_sfc_sp:filetm_other=',filetm_other(1,1),filetm_other(1,2),filetm_other(1,3) 
      print *, 'compare_list_sfc_sp:',filetm_other(2,1),filetm_other(2,2),filetm_other(2,3) 
      print *, 'compare_list_sfc_sp:',filetm_other(3,1),filetm_other(3,2),filetm_other(3,3) 
      print *, 'compare_list_sfc_sp:',filetm_other(4,1),filetm_other(4,2),filetm_other(4,3) 
       ...
       do i=1,ndata
         ...
         print *,'compare_list_sfc:filetm_o=',filetm_o(1),filetm_o(2),filetm_o(2),filetm_o(3)
          ...
          if(ntm ==2) then
             call check_data_sfc_sp_ttm2(ntm,dtype,filetype,filetm1,filetm_o,7000,nd,nd2,stdid,cid,rmean,&
                   std,std_no,tdata_no,xmed,break,iqcflg,ncount)
          else if(ntm ==3) then
             call check_data_sfc_sp_ttm3(ntm,dtype,filetype,filetm1,filetm_o,7000,nd,nd2,stdid,cid,rmean,&
                   std,std_no,tdata_no,xmed,break,iqcflg,ncount)
          else if(ntm ==4) then
             call check_data_sfc_sp_ttm4(ntm,dtype,filetype,filetm1,filetm_o,7000,nd,nd2,stdid,cid,rmean,&
                   std,std_no,tdata_no,xmed,break,iqcflg,ncount)
          endif
...
310  format(8f8.2)
     ...
     if(ndata ==1) then
        ...
        call check_list_sfc_sp(dtype,filetype,7000,nd,nd2,nstat2,nstat,2,1,&
        ...
        call check_list_sfc_sp(dtype,filetype,7000,nd,nd2,nstat3,nstat,3,1,&
             stdidout,cidout,rmeanout,stdout,xmedout,&
             breakout,std_noout,tdata_noout,iqcflgout,&
             stdid,cid,rmean,std,xmed,break,std_no,tdata_no,iqcflg,n)
        nstat=n
        ...
        tdata_noout(1,1:nstat,1:2)=tdata_no(1:nstat,1:2)
        iqcflgout(1,1:nstat)=iqcflg(1:nstat)
        call check_list_sfc_sp(dtype,filetype,7000,nd,nd2,nstat4,nstat,4,1,&
             stdidout,cidout,rmeanout,stdout,xmedout,&
             breakout,std_noout,tdata_noout,iqcflgout,&
             stdid,cid,rmean,std,xmed,break,std_no,tdata_no,iqcflg,n)
        nstat=n
        ...
        tdata_noout(1,1:nstat,1:2)=tdata_no(1:nstat,1:2)
        iqcflgout(1,1:nstat)=iqcflg(1:nstat)
        call check_list_sfc_sp(dtype,filetype,7000,nd,nd2,nstat5,nstat,5,1,&
             stdidout,cidout,rmeanout,stdout,xmedout,&
             breakout,std_noout,tdata_noout,iqcflgout,&
             stdid,cid,rmean,std,xmed,break,std_no,tdata_no,iqcflg,n)
        nstat=n
     ...
     fileo=trim(dtype)//'_'//trim(filetype)//'_sp_list'
