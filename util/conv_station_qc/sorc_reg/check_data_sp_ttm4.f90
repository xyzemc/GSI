...
!   compare their values  
      ...
      subroutine check_data_sp_ttm4(ntm,dtype,filetype,tm,filetm,n,nd,nd2,nk,stdid,&
      ...
      real(4),dimension(nk,nd) :: std_out3,rmean_out3
      ...
      real(4),dimension(nk,nd2) :: break_out2,break_out3 
      real(4),dimension(nk) :: std_no_input,std_no_out 
      real(4),dimension(nk) :: std_no_out2,std_no_out3 
...
!           print *,'1,check_data_sp_sfc:',tm1,rmean_input(1),std_input(1),std_no_input
           ...
           if(std2_exist .and. list2_true ) then
              ...
              iqcinput(1:nk)=iqcout(1:nk)
!              print *,'2,check_data_sp_sfc:',tm2,rmean_input(1),std_input(1),std_no_input
              call check_std_sp(dtype,tm3,filetype,nd,nd2,nk,stdid_input,rmean_input,std_input,&   
                        std_no_input,xmed_input,break_input,tno_input,iqcinput,nlev,& 
              ...
              if( std3_exist .and. list3_true) then
                 ...
                 tno(ncount,1:nk,1:2)=tno_out3(1:nk,1:2)
                 iqcflg(ncount,1:nk)=iqcout(1:nk)
!                   print *,'14,check_data_sp_sfc:',tm3,ncount,break(ncount,1),break(ncount,2),&
!                              break(ncount,3),break(ncount,4)
!                   print *,'14,check_data_sp_sfc:',xmed(ncount,1),xmed(ncount,2), &
...
!                              xmed(ncount,3),xmed(ncount,4)
                ...
                iqcflg(ncount,1:nk)=iqcout(1:nk)
!                   print *,'27,check_data_sp_sfc:',tm3,ncount,break(ncount,1),break(ncount,2),&
!                              break(ncount,3),break(ncount,4)
!                   print *,'27,check_data_sp_sfc:',xmed(ncount,1),xmed(ncount,2), &
!                              xmed(ncount,3),xmed(ncount,4)
              endif
           endif
           ...
           if(std2_exist .and. list2_true ) then
              ...
              tno_input(1:nk,1:2)=tno_out2(1:nk,1:2)
              iqcinput(1:nk)=iqcout(1:nk)
!                   print *,'28,check_data_sp_sfc:',tm3,ncount,break_input(1),break_input(2),&
!                              break_input(3),break_input(4),tno_input(1),tno_input(2)
!                   print *,'28,check_data_sp_sfc:',xmed_input(1),xmed_input(2), &
!                              xmed_input(3),xmed_input(4)
              ...
              if(std3_exist .and. list3_true ) then
                 ...
                 tno(ncount,1:nk,1:2)=tno_out3(1:nk,1:2)
                 iqcflg(ncount,1:nk)=iqcout(1:nk)
!                   print *,'35,check_data_sp_sfc:',tm3,ncount,break(ncount,1),break(ncount,2),&
!                              break(ncount,3),break(ncount,4)
!                   print *,'35,check_data_sp_sfc:',xmed(ncount,1),xmed(ncount,2), &
!                              xmed(ncount,3),xmed(ncount,4)
              else if (.not. std3_exist) then
                 ncount=ncount+1
                 stdid(ncount) = stdid_00(i)
                 ...
                 tno(ncount,1:nk,1:2)=tno_out2(1:nk,1:2)
                 iqcflg(ncount,1:nk)=iqcout(1:nk)
!                   print *,'39,check_data_sp_sfc:',tm3,ncount,break(ncount,1),break(ncount,2),&
!                              break(ncount,3),break(ncount,4)
!                   print *,'39,check_data_sp_sfc:',xmed(ncount,1),xmed(ncount,2), &
!                              xmed(ncount,3),xmed(ncount,4)
              endif           
           else if( .not.std2_exist) then
              call check_std_sp(dtype,tm3,filetype,nd,nd2,nk,stdid_input,rmean_input,std_input,&
              ...
              if(std3_exist .and. list3_true ) then
                 ...
                 iqcflg(ncount,1:nk)=iqcout(1:nk)
!                   print *,'53,check_data_sp_sfc:',tm3,ncount,break(ncount,1),break(ncount,2),&
!                              break(ncount,3),break(ncount,4)
!                   print *,'53,check_data_sp_sfc:',xmed(ncount,1),xmed(ncount,2), &
!                              xmed(ncount,3),xmed(ncount,4)
!              print *,'53,check_data_sp_sfc:',tm,rmean(ncount,1),std(ncount,1),std_no(ncount)
              endif
           endif
        endif
    enddo            
