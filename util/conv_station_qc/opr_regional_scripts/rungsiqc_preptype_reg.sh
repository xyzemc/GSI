...
# export savedir=/ptmpp1/Xiujuan.Su/post_regional
...
###  get data type directly from GSI diagnostic file for data 224 since prepbufr file contain old 224 file
#/bin/sh $scripts/runconv_stas.sh $scripts $datadir $exec ${exefile3} $savedir $fixfile $sdate $edate
