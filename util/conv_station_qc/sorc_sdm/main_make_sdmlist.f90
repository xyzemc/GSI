...
!      fileout=trim(ddtype)//'_rej_list'
       ...
       write(21,100)
          ...
          call compare_two_sfc(fileout,stdidall,ncount_all,filexist,itype,7000) 
       else if (nfile ==3) then
          call compare_three_sfc(fileout,stdidall,ncount_all,filexist,itype,7000) 
       else if (nfile ==4) then
          call compare_four_sfc(fileout,stdidall,ncount_all,filexist,itype,7000)
       endif 
