...
if (dtype =uv220); nhe=11;nz=43;endif
if (dtype =uv221); nhe=5; nz=43;endif
if (dtype =uv223); nhe=2; nz=43;endif
if (dtype =uv224); nhe=3; nz=43;endif
if (dtype =uv228); nhe=2; nz=43;endif
if (dtype =uv229); nhe=2; nz=43;endif
if (dtype =uv280); nhe=10; nz=1;endif
...
if(plotfile = uv221); 'set lat 0 60';'set lon 10 135';endif
if(plotfile = uv223); 'set lat 20 70';'set lon 200 290';endif
...
if(plotfile = uv221); 'set lat -60 0';'set lon 40 180';endif
