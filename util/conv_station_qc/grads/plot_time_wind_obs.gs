...
plottime(ix,nz,stationid,lon,lat,hgt,styp,dtype,dir,sdate,debug)
...
jiz=jiz+1
endwhile
rz1=iz+1;rz2=iz+2;rz3=iz+3
'draw string '1.0' 'ystring' 'dtype'('var'),stid('ix'):'stationid',lat:'lat',lon:'lon',st. height:'hgt',levs:'levz.rz1'(b),'levz.rz2'(r),'levz.rz3'(g)' 
iz=iz+3
if=if+1
endwhile

*outfile=dtype'_'var'_'iz'_'ix'.png'
outfile=dtype'_'var'_obs_'iz'_'stationid'.png'
