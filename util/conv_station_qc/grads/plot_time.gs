...
plottime(ix,nz,stationid,lon,lat,hgt,styp,dtype,stdate,debug)
 
ix=ix+1
endwhile

function plottime(ix,nz,stationid,lon,lat,hgt,styp,dtype,stdate,debug) 
...
rrz=rz-1
*outfile=dtype'_'ix'_'stationid'_'levz.rz'.png'
outfile=dtype'_'stationid'_'levz.rrz'.png'
