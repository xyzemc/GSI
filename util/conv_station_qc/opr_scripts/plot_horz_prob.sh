#u## the script plot horrizontal uumap of statistics
set -xa
...
export WSHOME=/export/emc-lw-xsu/wd20xs/gsiqc3/$dtype/horz_sus/${sdate}-${edate}
...
#--- preparation
  ...
  tmpdir=/ptmpp1/$USER/gsiqc3/plothorz_prob/$dtype
