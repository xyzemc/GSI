...
module fv3_interface
  ...
  integer, parameter :: n_inc_vars = 15  !! number of known variables
  ...
  character(len=11), dimension(n_inc_vars) :: output_vars=(/       &
       'sulf_inc   ', 'bc1_inc    ', 'bc2_inc    ', 'oc1_inc    ', &
       'oc2_inc    ', 'dust1_inc  ', 'dust2_inc  ', 'dust3_inc  ', &
       'dust4_inc  ', 'dust5_inc  ', 'seas1_inc  ', 'seas2_inc  ', &
       'seas3_inc  ', 'seas4_inc  ', 'seas5_inc  ' /)
