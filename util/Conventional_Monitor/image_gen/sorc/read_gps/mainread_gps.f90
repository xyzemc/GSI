...
!-----------------------------------------------
   ...
   print *,'etrmax, etrmin = ', etrmax, etrmin

   if (ituse >0) call read_gps(nreal,mtype,fname,fileo,gtross,rlev) 
   if (ituse <0) call read_gps_mor(nreal,mtype,fname,fileo,gtross,rlev) 
